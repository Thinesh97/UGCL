<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/SNC.Master" AutoEventWireup="true" CodeBehind="EmployeeContract.aspx.cs" Inherits="EmployeeContract" %>
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <asp:TextBox runat="server" ID="txtFatherName" autocomplete= "off" CssClass="form-control" TabIndex="7"></asp:TextBox>
                </div>
                <div class="col-md-2">Employee Permanent Address</div>
                <div class="col-md-4">
                    <asp:TextBox runat="server" ID="txtEmployee_Permanent_Address" autocomplete= "off" CssClass="form-control" TabIndex="7"></asp:TextBox>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <asp:TextBox runat="server" ID="txtEmail_ID" autocomplete= "off" CssClass="form-control" TabIndex="7"></asp:TextBox>
                </div>
                <div class="col-md-2">Qualification</div>
                <div class="col-md-4">
                    <asp:TextBox runat="server" ID="txtQualification" autocomplete= "off" CssClass="form-control" TabIndex="7"></asp:TextBox>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-2">Gender</div>
                    <div class="col-md-4">
                       <asp:dropdownlist runat="server" id="ddlGender" CssClass="form-control" TabIndex="11"> 
                ...
                <div class="col-md-4">
                    <asp:TextBox runat="server" ID="txtEmployee_Mobile_No" MaxLength="10" autocomplete= "off" CssClass="form-control input-pos-int" TabIndex="9"></asp:TextBox>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <asp:TextBox runat="server" ID="txtDate_of_Birth" autocomplete= "off" CssClass="form-control" onkeypress="javascript:return false;" onpaste="javascript:return false;" TabIndex="8"></asp:TextBox>
                ...
                <div class="col-md-4">
                     <asp:dropdownlist runat="server" id="ddlEmployment_Type" CssClass="form-control" TabIndex="11"> 
                          <asp:ListItem>-Select-</asp:ListItem>
             ...
             <div class="row">
                ...
                <div class="col-md-4">
                     <asp:DropDownList ID="ddlProjects" runat="server" CssClass="form-control" ></asp:DropDownList>
            ...
            <div class="row">
               <div class="col-md-2">Reporting Manager</div>
                <div class="col-md-4">
                    <asp:TextBox runat="server" ID="txtReporting_Manager"  autocomplete= "off" CssClass="form-control" TabIndex="9"></asp:TextBox>
                </div>
        ...
        <div class="panel-heading">
            ...
            <h3 class="panel-title">
               ...
               <thead>
                   <tr>
                       ...
                       <td style="  text-align:center;font-size:14px"><b>Yearly</b></td>
                   </tr>
               </thead>
                <tbody>
                    <tr>
                        <td>Basic Pay</td>
                            <td class="col-md-4"><asp:TextBox runat="server" ID="txtBasic_Pay" autocomplete= "off" CssClass="form-control CalculateSubTotal" TabIndex="8"></asp:TextBox></td >
                            <td class="col-md-4"><asp:TextBox runat="server" ID="txtBasic_PayY" autocomplete= "off" CssClass="form-control" TabIndex="8"></asp:TextBox></td>
                    </tr>
                     <tr>
                        <td>House Rental Allowance</td>
                         <td class="col-md-4"><asp:TextBox runat="server" ID="txtHouse_Rental_Allowance" autocomplete= "off" CssClass="form-control CalculateSubTotal" TabIndex="8"></asp:TextBox></td >
                         <td class="col-md-4"><asp:TextBox runat="server" ID="txtHouse_Rental_AllowanceY" autocomplete= "off" CssClass="form-control" TabIndex="8"></asp:TextBox></td >
                    </tr>
                     <tr>
                        <td>Conveyance Allowance</td>
                       <td class="col-md-4"><asp:TextBox runat="server" ID="txtConveyance_Allowance" autocomplete= "off" CssClass="form-control CalculateSubTotal" TabIndex="8"></asp:TextBox></td >
                        <td class="col-md-4"><asp:TextBox runat="server" ID="txtConveyance_AllowanceY" autocomplete= "off" CssClass="form-control" TabIndex="8"></asp:TextBox></td >
                    </tr>
                    <tr>
                        <td>Special Allowance</td>
                        <td class="col-md-4"><asp:TextBox runat="server" ID="txtSpecial_Allowance" autocomplete= "off" CssClass="form-control CalculateSubTotal" TabIndex="8"></asp:TextBox></td >
                         <td class="col-md-4"><asp:TextBox runat="server" ID="txtSpecial_AllowanceY" autocomplete= "off" CssClass="form-control" TabIndex="8"></asp:TextBox></td >
                    ...
                    <tr>
                       ...
                       <td class="col-md-4"><asp:TextBox runat="server" ID="txtSub_Total_A" autocomplete= "off" CssClass="form-control" TabIndex="8"></asp:TextBox></td >
                         <td class="col-md-4"><asp:TextBox runat="server" ID="txtSub_Total_AY" autocomplete= "off" CssClass="form-control" TabIndex="8"></asp:TextBox></td >
                    ...
                    <tr>
                        <td>Provident Fund Employer</td>
                         ...
                         <td class="col-md-4"><asp:TextBox runat="server" ID="txtPF_ERY" autocomplete= "off" CssClass="form-control" TabIndex="8"></asp:TextBox></td >
                    </tr>
                    <tr>
                        <td style="font-size:14px"><b>Total Cost to the Company</b></td>
                        <td class="col-md-4"><asp:TextBox runat="server" ID="txtTotal_Cost_to_Company" autocomplete= "off" CssClass="form-control CalculateNetPayment" TabIndex="8"></asp:TextBox></td >
                        <td class="col-md-4"><asp:TextBox runat="server" ID="txtTotal_Cost_to_CompanyY" autocomplete= "off" CssClass="form-control" TabIndex="8"></asp:TextBox></td >
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td class="col-md-4"><asp:TextBox runat="server" ID="txtPF" autocomplete= "off" CssClass="form-control CalculateTotalDeductions" TabIndex="8"></asp:TextBox></td >
                        <td class="col-md-4"><asp:TextBox runat="server" ID="txtPFY" autocomplete= "off" CssClass="form-control" TabIndex="8"></asp:TextBox></td >
                    </tr>
                    <tr>
                        <td>Professional Tax</td>
                        <td class="col-md-4"><asp:TextBox runat="server" ID="txtPT" autocomplete= "off" CssClass="form-control CalculateTotalDeductions" TabIndex="8"></asp:TextBox></td >
                        <td class="col-md-4"><asp:TextBox runat="server" ID="txtPTY" autocomplete= "off" CssClass="form-control" TabIndex="8"></asp:TextBox></td >
                    </tr>
                    <tr>
                        <td style="font-size:14px"><b>Total Deductions (B)</b></td>
                        <td class="col-md-4"><asp:TextBox runat="server" ID="txtTotal_Deductions_B" autocomplete= "off" CssClass="form-control" TabIndex="8"></asp:TextBox></td >
                        <td class="col-md-4"><asp:TextBox runat="server" ID="txtTotal_Deductions_BY" autocomplete= "off" CssClass="form-control" TabIndex="8"></asp:TextBox></td >

                    </tr>
                    <tr>
                        <td style="font-size:14px"><b>Take Home (C = A- B)</b></td>
                        <td class="col-md-4"><asp:TextBox runat="server" ID="txtNET_PAYMENT" autocomplete= "off" CssClass="form-control CalculateNetPayment" TabIndex="8"></asp:TextBox></td >
                        <td class="col-md-4"><asp:TextBox runat="server" ID="txtNET_PAYMENTY" autocomplete= "off" CssClass="form-control" TabIndex="8"></asp:TextBox></td >
                    </tr>
            ...
            <h3 class="panel-title">
                ...
                <div class="col-md-4">
                     <asp:FileUpload runat="server" ID="fupResume"></asp:FileUpload>
                </div>
                      <div class="col-md-2">ID Proof</div>
                <div class="col-md-4">
                    <asp:FileUpload runat="server" ID="fupIDProof"></asp:FileUpload>
                </div>
        </div>
                      <div class="row">
                   <div class="col-md-2">Bank Details</div>
                <div class="col-md-4">
                      <asp:FileUpload runat="server" ID="fupBankDetails"></asp:FileUpload>
                </div>
                      <div class="col-md-2">Qualification Certificates</div>
                <div class="col-md-4">
                      <asp:FileUpload runat="server" ID="fupQualificationCertificates"></asp:FileUpload>
                </div>
        </div>
                      <div class="row">
                   <div class="col-md-2">Pay Slips</div>
                <div class="col-md-4">
                      <asp:FileUpload runat="server" ID="fupPaySlips"></asp:FileUpload>
                </div>
                      <div class="col-md-2">Other Documents</div>
                <div class="col-md-4">
                      <asp:FileUpload runat="server" ID="fupOtherDocuments"></asp:FileUpload>
                    <label runat="server"  id="fupOtherDocumentsBind"></label>
                </div>
