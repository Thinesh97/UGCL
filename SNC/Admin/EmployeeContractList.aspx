<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/SNC.Master" AutoEventWireup="true" CodeBehind="~/Admin/EmployeeContractList.aspx.cs" Inherits="EmployeeContractList" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <center>
                <ogrid:Grid runat="server" ID="Grid_EC" CallbackMode="false" AutoGenerateColumns="false" 
                    OnRowDataBound="Grid_EC_RowDataBound" 
                    ...
                    <Templates>
                        <ogrid:GridTemplate ID="ECNoTemplate" runat="server">
                            <Template>
                               <asp:HyperLink ID="lnkECNo" runat="server" CssClass="gridCB"  Text='<%#Container.DataItem["EmployeeID"] %>'>
                        </asp:HyperLink>
                            </Template>
                        </ogrid:GridTemplate>
                         <ogrid:GridTemplate ID="GT_EC_Delete" runat="server">
                            <Template>
                               <asp:LinkButton ID="lnkEC_Delete" runat="server" CssClass="gridCB" OnClientClick="beforedelete();" CommandArgument='<%# Container.PageRecordIndex %>'  OnCommand="lnkEC_Delete_Click" Text="Delete"></asp:LinkButton>
                            </Template>
                        </ogrid:GridTemplate>
                ...
                <br />
                <center>
                    <a href="EmployeeContract.aspx" runat="server" id="lnkbtnAdd" class="btn btn-default">Add New EC</a>               
