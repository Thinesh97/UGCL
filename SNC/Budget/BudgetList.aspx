<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/SNC.Master" AutoEventWireup="true" CodeBehind="~/Budget/BudgetList.aspx.cs" Inherits="BudgetList" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <center>
        <ogrid:Grid runat="server" ID="GridBudgetList" AllowGrouping="true" AutoGenerateColumns="false" FolderStyle="../Gridstyles/grand_gray" AllowAddingRecords="false" AllowFiltering="true" AllowPaging="true" PageSize="10">
            <ScrollingSettings ScrollWidth="100%" />
            <ExportingSettings ExportAllPages="true" ExportTemplates="true" ExportedFilesTargetWindow="New" 
                 ColumnsToExport="Abs_BID,Budget_ID,Year,MonthName,Project_Code,Project_Name,REP,Creation_Date,Closing_date,Total_Amount,Name,Description,Status"/>
            ...
            <TemplateSettings  TemplateId="Abs_BIDTemplate" />
                ...
                <ogrid:Column DataField="Project_Name" HeaderText="Project Name" Width="180px" ></ogrid:Column>
                 <ogrid:Column DataField="REP" HeaderText="Primary Person" Width="180px" ></ogrid:Column>
                 <ogrid:Column DataField="Creation_Date" HeaderText="Creation_Date" Width="180px"  DataFormatString="{0:dd-MM-yyyy}" ></ogrid:Column>
                 <ogrid:Column DataField="Closing_date" HeaderText="Closing_date" Width="180px" DataFormatString="{0:dd-MM-yyyy}" ></ogrid:Column>
                 ...
                 <ogrid:Column DataField="Description" HeaderText="Description" Wrap="true"></ogrid:Column>
        ...
        <ogrid:GridTemplate ID="Abs_BIDTemplate" runat="server">
            <Template>
                <a href='MonthlyBudget.aspx?ID=<%#Container.DataItem["Abs_BID"] %>'><%#Container.DataItem["Abs_BID"] %></a>
            </Template>
        </ogrid:GridTemplate>
                      ...
                      <br />
                <a href="MonthlyBudget.aspx" runat="server" id="lnkbtnAdd" class="btn btn-default">Create Budget</a>
