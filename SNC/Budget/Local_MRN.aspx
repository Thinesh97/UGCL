<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/SNC.Master" AutoEventWireup="true" CodeBehind="~/Budget/Local_MRN.aspx.cs" Inherits="Local_MRN" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="panel">
        ...
        <div class="panel-body">
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <asp:DropDownList ID="ddlMonth" runat="server" CssClass="form-control" Enabled="true">
                        <asp:ListItem Text="Select"></asp:ListItem>
                    </asp:DropDownList>
                </div>
                <div class="col-md-2">
                    Year
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator9" runat="server" InitialValue="-Select-" ControlToValidate="ddlYear" CssClass="Validation_Text" ValidationGroup="SaveBudget" ErrorMessage="*"></asp:RequiredFieldValidator>

                </div>
                <div class="col-md-4">
                    <asp:DropDownList ID="ddlYear" runat="server" CssClass="form-control" Enabled="true">
                        <asp:ListItem Text="Select"></asp:ListItem>
                    </asp:DropDownList>
                </div>
             ...
             <%--   
                ...
                <div class="col-md-4">
                    <asp:TextBox ID="txtYear" runat="server" Enabled="true" CssClass="form-control"></asp:TextBox>
                </div>--%>
            </div>
            <%--<div class="row">
                <div class="col-md-2">
            ...
            <div class="row">
               <%--  <div class="col-md-2">
                    Sector
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator11" runat="server" InitialValue="-Select-" ControlToValidate="ddlSector" CssClass="Validation_Text" ValidationGroup="SaveBudget" ErrorMessage="*"></asp:RequiredFieldValidator>

                </div>
                <div class="col-md-4">
                    <asp:DropDownList ID="ddlSector" runat="server" CssClass="form-control" Enabled="true">
                        <asp:ListItem Text="Select"></asp:ListItem>
                    </asp:DropDownList>
                </div>--%>
                    <div class="col-md-2">
                    Amount
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator12" runat="server" ControlToValidate="txt_Amt" CssClass="Validation_Text" ValidationGroup="SaveBudget" ErrorMessage="*"></asp:RequiredFieldValidator>
                       <asp:FilteredTextBoxExtender ID="FilteredTextBoxExtender7" runat="server" FilterType="Numbers, Custom" ValidChars="." TargetControlID="txt_Amt" />
                </div>
                <div class="col-md-4">
                    <asp:TextBox ID="txt_Amt" runat="server" Enabled="true" CssClass="form-control"></asp:TextBox>
                </div>
                </div>
            <div class="row">
                <div class="col-md-2">
        ...
        <div class="modal-footer">
           ...
           <asp:Button ID="btnSaveBudget" runat="server" Text="Save"  CssClass="btn btn-default" ValidationGroup="SaveBudget" OnClick="btnSaveBudget_Click" TabIndex="6"  />
                        <asp:Button ID="btnCancelItem" runat="server" Text="Cancel"  CssClass="btn btn-default" CausesValidation="false" PostBackUrl="~/Budget/Local_MRN_List.aspx" TabIndex="7"   />
    ...
    <div id="accordion1">
        <ul runat="server" id="ItemListContainer" visible="false">
            ...
            <li style="background-color: #f6c8c8;">
                <h1>Automobiles </h1>
                <asp:Label runat="server" ID="lblAutoTotal" CssClass="h1" Text="0"></asp:Label>
            ...
            <li>
                ...
                <asp:Label runat="server" CssClass="h1" Text="0" ID="lblTotalValuesPlant"></asp:Label>
                <div class="panel-body">
                    <p class="alnright">
            ...
            <li style="background-color: #f6c8c8;">
                ...
                <asp:Label runat="server" CssClass="h1" Text="0" ID="lblShutteringTotal"></asp:Label>
                <div class="panel-body">
                    <p class="alnright">
 ...
 <asp:GridView runat="server" ShowFooter="true" ID="GridShutter" DataKeyNames="Bud_Item_Id" OnRowCommand="BudgetList_RowCommand" OnRowDataBound="GridShutter_RowDataBound" CssClass="table tbl1" AutoGenerateColumns="false" ShowHeaderWhenEmpty="true" ShowHeader="true" >
            ...
            <li>
                ...
                <asp:Label runat="server" CssClass="h1" Text="0" ID="lblConsumeTotal"></asp:Label>
                <div class="panel-body">
                    <p class="alnright">
            ...
            <li style="background-color: #f6c8c8;">
                ...
                <asp:Label runat="server" CssClass="h1" Text="0" ID="lblTotalElect"></asp:Label>
                <div class="panel-body">
                    <p class="alnright">
 ...
 <asp:GridView runat="server" ShowFooter="true" ID="Grid_Elect" DataKeyNames="Bud_Item_Id" OnRowCommand="BudgetList_RowCommand" OnRowDataBound="Grid_Elect_RowDataBound" CssClass="table tbl1" AutoGenerateColumns="false" ShowHeaderWhenEmpty="true" ShowHeader="true" >
            ...
            <li>
                <h1>HSD</h1>
                <asp:Label runat="server" CssClass="h1" Text="0" ID="lblTotalHSD"></asp:Label>
                <div class="panel-body">
                    <p class="alnright">
            ...
            <li style="background-color: #f6c8c8;">
                ...
                <asp:Label runat="server" CssClass="h1" Text="0" ID="lblTotalOil"></asp:Label>
                <div class="panel-body">
                    <p class="alnright">
            ...
            <li>
                ...
                <asp:Label runat="server" CssClass="h1" Text="0" ID="lblTotalHardware"></asp:Label>
                <div class="panel-body">
                    <p class="alnright">
            ...
            <li style="background-color: #f6c8c8;">
                ...
                <asp:Label runat="server" CssClass="h1" Text="0" ID="lblTotalWelding"></asp:Label>
                <div class="panel-body">
                    <p class="alnright">
            ...
            <li>
                ...
                <asp:Label runat="server" CssClass="h1" Text="0" ID="lblTotalOxygen"></asp:Label>
                <div class="panel-body">
                    <p class="alnright">
            ...
            <li style="background-color: #f6c8c8;">
                <h1>Safety Items</h1>
                <asp:Label runat="server" CssClass="h1" Text="0" ID="lblTotalSafety"></asp:Label>
                <div class="panel-body">
                    <p class="alnright">
            ...
            <li>
                <h1>Staff Welfare</h1>
                <asp:Label runat="server" CssClass="h1" Text="0" ID="lblTotalStaff"></asp:Label>
                <div class="panel-body">
                    <p class="alnright">
            ...
            <li style="background-color: #f6c8c8;">
                ...
                <asp:Label runat="server" CssClass="h1" Text="0" ID="lblTotalMess"></asp:Label>
            ...
            <li>
                ...
                <asp:Label runat="server" CssClass="h1" Text="0" ID="lblTotalPrinting"></asp:Label>
                <div class="panel-body">
                    <p class="alnright">
            ...
            <li style="background-color: #f6c8c8;">
                ...
                <asp:Label runat="server" CssClass="h1" Text="0" ID="lblTotalRepairs"></asp:Label>
                <div class="panel-body">
                    <p class="alnright">
            ...
            <li>
                <h1>BOQ Items</h1>
                <asp:Label runat="server" CssClass="h1" Text="0" ID="lblTotalBoQ"></asp:Label>
                <div class="panel-body">
                    <p class="alnright">
            ...
            <li style="background-color: #f6c8c8;">
                ...
                <asp:Label runat="server" CssClass="h1" Text="0" ID="lblTotalSanitary"></asp:Label>
                <div class="panel-body">
                    <p class="alnright">
            ...
            <li>
                ...
                <asp:Label runat="server" CssClass="h1" Text="0" ID="lblTotalBlasting"></asp:Label>
                <div class="panel-body">
                    <p class="alnright">
            ...
            <li style="background-color: #f6c8c8;">
                ...
                <asp:Label runat="server" CssClass="h1" Text="0" ID="lblTotalFurnitures"></asp:Label>
                <div class="panel-body">
                    <p class="alnright">
            ...
            <li>
                <h1>Fixed Assets</h1>
                <asp:Label runat="server" CssClass="h1" Text="0" ID="lblTotalFixedAssets"></asp:Label>
                <div class="panel-body">
                    <p class="alnright">
            ...
            <li style="background-color: #f6c8c8;">
                ...
                <asp:Label runat="server" CssClass="h1" Text="0" ID="lblTotalInfrastructure"></asp:Label>
                <div class="panel-body">
                    <p class="alnright">
            ...
            <li>
                <h1>Sand</h1>
                <asp:Label runat="server" CssClass="h1" Text="0" ID="lblTotalSand"></asp:Label>
                <div class="panel-body">
                    <p class="alnright">
            ...
            <li style="background-color: #f6c8c8;">
                ...
                <asp:Label runat="server" CssClass="h1" Text="0" ID="lblTotalJelly"></asp:Label>
                <div class="panel-body">
                    <p class="alnright">
            ...
            <li>
                <h1>Red Soil</h1>
                <asp:Label runat="server" CssClass="h1" Text="0" ID="lblRedSoil"></asp:Label>
                <div class="panel-body">
                    <p class="alnright">
            ...
            <li style="background-color: #f6c8c8;">
                <h1>Cement</h1>
                <asp:Label runat="server" CssClass="h1" Text="0" ID="lblTotalCement"></asp:Label>
                <div class="panel-body">
                    <p class="alnright">
            ...
            <li>
                <h1>Chemicals</h1>
                <asp:Label runat="server" CssClass="h1" Text="0" ID="lblTotalChemicals"></asp:Label>
                <div class="panel-body">
                    <p class="alnright">
            ...
            <li style="background-color: #f6c8c8;">
                <h1>Bricks</h1>
                <asp:Label runat="server" CssClass="h1" Text="0" ID="lblTotalBricks"></asp:Label>
                <div class="panel-body">
                    <p class="alnright">
            ...
            <li>
                <h1>Steels</h1>
                <asp:Label runat="server" CssClass="h1" Text="0" ID="lblTotalSteels"></asp:Label>
                <div class="panel-body">
                    <p class="alnright">
            ...
            <li style="background-color: #f6c8c8;">
                ...
                <asp:Label runat="server" CssClass="h1" Text="0" ID="lblTotal_OtherConstruction"></asp:Label>
                <div class="panel-body">
                    <p class="alnright">
            ...
            <li>
                <h1>Others</h1>
                <asp:Label runat="server" CssClass="h1" Text="0" ID="lblTotalOthers"></asp:Label>
                <div class="panel-body">
                    <p class="alnright">
