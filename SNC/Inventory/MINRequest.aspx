<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/SNC.Master" AutoEventWireup="true" CodeBehind="MINRequest.aspx.cs" Inherits="SNC.Inventory.MINRequest" %>
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <center>
                ...
                <%--i am creating oboutgrid here-- % <ogrid:Column DataField="MIN_Item_ID" HeaderText="Item ID"  Visible="true"></ogrid:Column>>--%>
                  <ogrid:Grid runat="server" ID="ItemList_Grid" CallbackMode="false" OnDeleteCommand="ItemList_Grid_DeleteCommand" AutoGenerateColumns="false"  AllowRecordSelection="false" FolderStyle="../Gridstyles/grand_gray" AllowAddingRecords="false" AllowFiltering="true" AllowPaging="true" PageSize="10">         
            ...
            <TemplateSettings  TemplateId="ListItemTemplate"/>
                ...
                <ogrid:Column DataField="Category_Name" HeaderText="Category_Name" Width="130"></ogrid:Column>
                 ...
                 <ogrid:Column DataField="Recurring" HeaderText="Recurring" Width="100"></ogrid:Column>
                  <ogrid:Column DataField="RequestedQty" HeaderText="Requested Quantity" Align="right" Width="110"></ogrid:Column>
       ...
       <%-- <ogrid:GridTemplate ID="ListItemTemplate" runat="server">
            <Template>
                ...
                <asp:LinkButton ID="lnkMINItemID" runat="server" OnClick="lnkMINItemID_Click"  CssClass="gridCB" Text='<%# Convert.ToInt32(Container.DataItem["MIN_Item_ID"])!= null ? "Delete": "" %>'>
 </asp:LinkButton>
            </Template>
        </ogrid:GridTemplate>--%>
