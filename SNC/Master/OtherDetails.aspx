<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/SNC.Master" AutoEventWireup="true" CodeBehind="OtherDetails.aspx.cs" Inherits="OtherDetails" %>
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    <asp:TextBox ID="txtOtherID" CssClass="form-control" runat="server" MaxLength="8" Enabled="false"></asp:TextBox>
                </div>
                <div class="col-md-1">
                    Other Name
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="*" CssClass="Validation_Text" ValidationGroup="ValOtherInfo" ControlToValidate="txtOtherName"></asp:RequiredFieldValidator>
                </div>
                <div class="col-md-3">
                    <asp:TextBox ID="txtOtherName" CssClass="form-control" runat="server" MaxLength="100" TabIndex="1"></asp:TextBox>
                </div>
                <div class="col-md-1">
                    Registration No
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ErrorMessage="*" CssClass="Validation_Text" ValidationGroup="ValOtherInfo" ControlToValidate="txtRegistrationNo"></asp:RequiredFieldValidator>
                </div>
                <div class="col-md-3">
            ...
            <div class="row">
                <asp:UpdatePanel ID="UPDL_Pan" runat="server">
                    <ContentTemplate>
                        <div class="col-md-1">
                            Use PAN
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ErrorMessage="*" CssClass="Validation_Text" ValidationGroup="ValOtherInfo" ControlToValidate="rd_usepan"></asp:RequiredFieldValidator>
                        </div>
                        <div class="col-md-3">
                        ...
                        <div class="col-md-1">
                            PAN No
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ErrorMessage="*" CssClass="Validation_Text" ValidationGroup="ValOtherInfo" ControlToValidate="txtPANNo"></asp:RequiredFieldValidator>
                        </div>
                        <div class="col-md-3">
            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    ...
                    <asp:RegularExpressionValidator ID="RegularExpressionValidator6" runat="server"
                        ControlToValidate="txtEmailID" CssClass="Validation_Text" ValidationGroup="ValOtherInfo"
                ...
                <div class="col-md-1">
                    Address Line 1
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ErrorMessage="*" CssClass="Validation_Text" ValidationGroup="ValOtherInfo" ControlToValidate="txtaddr"></asp:RequiredFieldValidator>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-md-1">
                    City
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" ErrorMessage="*" CssClass="Validation_Text" ValidationGroup="ValOtherInfo" ControlToValidate="txtCity"></asp:RequiredFieldValidator>
                </div>
                <div class="col-md-3">
                ...
                <div class="col-md-1">
                    Country
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator9" runat="server" ErrorMessage="*" InitialValue="-Select-" CssClass="Validation_Text" ValidationGroup="ValOtherInfo" ControlToValidate="ddlCountry"></asp:RequiredFieldValidator>
            ...
            <div class="row">
                <div class="col-md-1">
                    State
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator8" runat="server" ErrorMessage="*" InitialValue="-Select-" CssClass="Validation_Text" ValidationGroup="ValOtherInfo" ControlToValidate="ddlState"></asp:RequiredFieldValidator>
                ...
                <div class="col-md-1">
                    Bank Name1
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator10" runat="server" ErrorMessage="*" CssClass="Validation_Text" ValidationGroup="ValOtherInfo" InitialValue="-Select-" ControlToValidate="ddlBankName"></asp:RequiredFieldValidator>
            ...
            <div class="row">
                <div class="col-md-1">
                    Branch Name1
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator11" runat="server" ErrorMessage="*" CssClass="Validation_Text" ValidationGroup="ValOtherInfo" ControlToValidate="txtBranchName"></asp:RequiredFieldValidator>
                </div>
                <div class="col-md-3">
                ...
                <div class="col-md-1">
                    Account Type1
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator12" runat="server" ErrorMessage="*" CssClass="Validation_Text" ValidationGroup="ValOtherInfo" ControlToValidate="rd_accountype"></asp:RequiredFieldValidator>
                </div>
                <div class="col-md-3">
                ...
                <div class="col-md-1">
                    Account No1
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator13" runat="server" ErrorMessage="*" CssClass="Validation_Text" ValidationGroup="ValOtherInfo" ControlToValidate="txtAccountNo"></asp:RequiredFieldValidator>
                </div>
                <div class="col-md-3">
            ...
            <div class="row">
                <div class="col-md-1">
                    IFSC Code1
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator14" runat="server" ErrorMessage="*" CssClass="Validation_Text" ValidationGroup="ValOtherInfo" ControlToValidate="txtIFSCCode"></asp:RequiredFieldValidator>
                </div>
                <div class="col-md-3">
            ...
            <div class="row">
                ...
                <div class="row">
                    <div class="col-md-12 text-center">
                        <asp:Button ID="btnSubmit" runat="server" Text="Submit" OnClick="btnSubmit_Click" CssClass="btn btn-default" ValidationGroup="ValOtherInfo" TabIndex="29"></asp:Button>
