<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/SNC.Master" AutoEventWireup="true" CodeBehind="OtherList.aspx.cs" Inherits="OtherList" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <center>
            <ogrid:Grid runat="server" ID="OtherGrid" AutoGenerateColumns="false" OnRowDataBound="OtherGrid_RowDataBound" CallbackMode="false" OnDeleteCommand="OtherGrid_DeleteCommand" FolderStyle="../Gridstyles/grand_gray" AllowAddingRecords="false" AllowFiltering="true" AllowPaging="true" PageSize="10">
                <ScrollingSettings ScrollWidth="100%" />
                <ExportingSettings ExportAllPages="true" ExportTemplates="true" 
                    ColumnsToExport = "Other_ID,Other_Name,Regs_No,Con_Person,Con_No,Email_ID,PAN_No,Bank,PFRegistration_No,LabourLicence_No,Branch,Acc_No,IFSC,Add_Line,Landmark,City,State,Country,Pin,ST_No,Account_Type,Bank2,Branch2,Account_Type2,Acc_No2,IFSC2,Nature_Work,Remark,RefPerson,File_GSTRegistration,File_PANCopy,File_BankDetails,Is_Asset" />
                ...
                <Columns>  
                    <ogrid:Column DataField="Other_ID" HeaderText="Other ID" runat="server" Width="100px" >
                        <TemplateSettings  TemplateId="OtherIDTemplate"/>
                    </ogrid:Column> 
                    <ogrid:Column DataField="Other_name" HeaderText="Other Name" Wrap="true" Width="250px"></ogrid:Column>
                    ...
                    <ogrid:Column DataField="" HeaderText="Delete" AllowDelete="true"  Width="90px">
                        <TemplateSettings  TemplateId="GT_Other_Delete"/>
                    </ogrid:Column>
                </Columns>
            
                <Templates>
                    <ogrid:GridTemplate ID="OtherIDTemplate" runat="server">
                        <Template>               
                            <asp:HyperLink ID="lnlOtherID" runat="server" CssClass="gridCB" Text='<%#Container.DataItem["Other_ID"] %>'></asp:HyperLink>
                        </Template>
                    </ogrid:GridTemplate>
                    ...
                    <ogrid:GridTemplate ID="GT_Other_Delete" runat="server">
                        <Template>
                            <asp:LinkButton ID="lnkOther_Delete" runat="server" CssClass="gridCB" OnClientClick="beforedelete();" CommandArgument='<%# Container.PageRecordIndex %>'  OnCommand="lnkOther_Delete_Click" Text="Delete"></asp:LinkButton>
                        </Template>
                    </ogrid:GridTemplate>
            ...
            <asp:LinkButton ID="lnkbtnAdd" Text="Add New Other" PostBackUrl="~/Master/OtherDetails.aspx" CssClass="btn btn-default"  runat="server"></asp:LinkButton>
