...
public partial class DirectPurchaseOrder : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            if (!IsPostBack)
            {
                //Grid_DirectRFQItem.Visible = false;
                //Grid_DirectRFQTax.Visible = false;
                if (Session["UID"] != null)
                {
                    BindVendorList();
                    BindUsersNames();
                    ...
                    if (Request.QueryString["PONo"] != null && Request.QueryString["s"] != null)
                    {
                        ...
                        string message = "Direct PO has been Created Successfully";
    ...
    protected void BindRFQNoList()
    {
        try
        {
            ...
            objRFQ.load(con, RequestForquotationBL.eLoadSp.SELECT_RFQ_No, ref ds);
            ddlrfqno.DataSource = ds;
            ddlrfqno.DataTextField = "RFQNo";
            ddlrfqno.DataValueField = "RFQNo";
            ddlrfqno.DataBind();
            ddlrfqno.Items.Insert(0, "-Select-");
        }
        catch (Exception ex)
        {
    ...
    private void GetPurchaseOrderDetails(string PONo)
    {
        try
        {
            ...
            if (ds.Tables[0].Rows.Count > 0)
            {
                ...
                ViewState["RFQNo"] = ds.Tables[0].Rows[0]["RFQNo"].ToString();
                ddlrfqno.SelectedValue = ds.Tables[0].Rows[0]["RFQNo"].ToString();
                ddlrfqno_SelectedIndexChanged(null, null);
    ...
    private void GetRFQDetails(string RFQNo)
    {
        try
        {
            ...
            {
                ddlrfqno.SelectedValue = ds.Tables[0].Rows[0]["RFQNo"].ToString();
                txtPODate.Text = ds.Tables[0].Rows[0]["RFQDate"].ToString();
                ddlProject.SelectedValue = ds.Tables[0].Rows[0]["Project_Code"].ToString();
                txtDeliverySchedule.Text = ds.Tables[0].Rows[0]["DeliverySchedule"].ToString();
                ddlVendor.SelectedValue = ds.Tables[0].Rows[0]["VendorID"].ToString();
                if (ds.Tables[0].Rows[0]["FYear"].ToString() != string.Empty)
                ...
                //ViewState["RFQNo"] = ds.Tables[0].Rows[0]["RFQNo"].ToString();
                // objRFQ.RFQNo = ViewState["RFQNo"].ToString();
                ddlrfqno.EnableViewState = true;
                if (ds.Tables[0].Rows[0]["Status"].ToString() != string.Empty)
                {
                    rblStatus.SelectedValue = ds.Tables[0].Rows[0]["Status"].ToString();
                }
    ...
    private void BindRFQItems()
    {
        try
        {
            if (objRFQ.RFQNo != null)
            {
                objPO = new PurchaseOrderBL();
                objRFQ = new RequestForquotationBL();
                ds = new DataSet();

                objRFQ.RFQNo = ddlrfqno.SelectedValue;
                //objRFQ.RFQNo = int.Parse(ViewState["RFQNo"].ToString());
                //objRFQ.RFQ_ID = Convert.ToInt32(ViewState["RFQID"]);
                objRFQ.load(con, RequestForquotationBL.eLoadSp.SELECT_RFQ_ITEM_BY_RFQNo, ref ds);
                Total_Amount = 0;
                Grid_DirectRFQItem.DataSource = ds;
                ddlDispatchTo.DataTextField = "RFQNo";
                ddlDispatchTo.DataValueField = "RFQNo";
            ...
            else
            {
                ...
                objPO.RFQNo = ddlrfqno.SelectedValue;
    ...
    protected void ddlrfqno_SelectedIndexChanged(object sender, EventArgs e)
    {
        if (ddlrfqno.SelectedIndex != 0)
        {
            objRFQ = new RequestForquotationBL();
            ds = new DataSet();
            objRFQ.RFQNo = ddlrfqno.SelectedValue;
            objRFQ.load(con, RequestForquotationBL.eLoadSp.SELECT_RFQ_DETAILS_BY_ID, ref ds);
            if (ds.Tables.Count > 0)
            {
                ddlProject.SelectedValue = ds.Tables[0].Rows[0]["Project_Code"].ToString();
                txtDeliverySchedule.Text = ds.Tables[0].Rows[0]["DeliverySchedule"].ToString();
                ...
                txtTINNo.Text = ds.Tables[0].Rows[0]["TIN_No"].ToString();
                rblStatus.SelectedValue = ds.Tables[0].Rows[0]["Status"].ToString();
                txtDispatchMode.Text = ds.Tables[0].Rows[0]["DespatchAdvise"].ToString();
                ddlTDSPerc.SelectedValue = ds.Tables[0].Rows[0]["TDSPerc"].ToString();
                txtPlaceofDispatch.Text = ds.Tables[0].Rows[0]["Place_of_Dispatch"].ToString();
                txtDestination.Text = ds.Tables[0].Rows[0]["Destination"].ToString();
                txtRemarks.Text = ds.Tables[0].Rows[0]["Remarks"].ToString();
                ...
                BindRFQTax();
                BindRFQItems();
                Grid_DirectRFQItem.Visible = true;
                Grid_DirectRFQTax.Visible = true;
            }
    ...
    private void BindRFQTax()
    {
        try
        {
            ...
            objRFQ.RFQNo = ddlrfqno.SelectedValue;
            objRFQ.RFQ_ID = Convert.ToInt32(ViewState["RFQID"]);
            objRFQ.load(con, RequestForquotationBL.eLoadSp.SELECT_RFQ_TAX_BY_RFQNO, ref ds);
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            objPO.FYear = ddlFYear.SelectedValue.Trim();
            objPO.Month_PO = ddlMonth.SelectedValue.Trim();
            objPO.ProjectCode = ddlProject.SelectedValue.Trim();
            ...
            objPO.RFQNo = ddlrfqno.SelectedValue.Trim();
            objRFQ.RFQNo = ddlrfqno.SelectedValue.Trim();
            ViewState["RFQNo"] = objPO.RFQNo.ToString();
            ...
            objPO.Destination = txtDestination.Text.Trim();
            objPO.Place_of_Dispatch = txtPlaceofDispatch.Text.Trim();
            objPO.DespatchAdvise = ddlDispatchTo.SelectedItem.Text;
            objPO.ContactName = txtContactName.Text.Trim();
            objPO.ContactNo = txtContactNo.Text.Trim();
            objPO.PaymentTerms = txtPayTerms.Text;
            ...
            objPO.Others = txtOthers.Text;
            objPO.ProjectCode = ddlProject.SelectedValue.ToString();
            objPO.DispatchMode = txtDispatchMode.Text.Trim();
            objPO.Approver_Com = txtApproverComments.Text.Trim();
            objPO.TDSPerc = Convert.ToDecimal(ddlTDSPerc.SelectedValue);

            objPO.Task = "InsertDirectPO";

            if (Session["UID"] != null)
            {
                objPO.UserID = Convert.ToInt32(Session["UID"].ToString());
            }
            ...
            if (btnSubmit.Text == "Submit")
            {
                ...
                else
                {
                    if (objPO.insert(con, PurchaseOrderBL.eLoadSp.INSERT))
                    {
                        ...
                        //ddlrfqno.Visible = true;

                        txtPONo.Text = objPO.PONo.ToString();
                        ViewState["PONo"] = objPO.PONo.ToString();
                        ViewState["POID"] = Convert.ToInt32(objPO.PO_ID);
                        Response.Redirect("DirectPurchaseOrder.aspx?PONo=" + ViewState["PONo"].ToString() + "&s=1", false);
                        ddlrfqno.EnableViewState = true;
                        ddlrfqno.SelectedValue = objPO.RFQNo.ToString();
                        //ViewState["RFQNo"] = objPO.RFQNo.ToString();

                        ScriptManager.RegisterStartupScript(this, GetType(), "CustomAlert", "Alert.render('Direct PO details has been inserted sucessfully.');", true);
                        BindRFQItems();
                        //ddlrfqno.SelectedValue = objPO.RFQNo;

                    }
                    else
                    {
                        ScriptManager.RegisterStartupScript(this, GetType(), "CustomAlert1", "Alert1.render('Failed to insert Direct PO details !.');", true);
                    }
                }
            }
            else
            {
                objPO.Task = "UpdateDirectPO";
                objPO.PONo = txtPONo.Text.ToString();
                if (fuDPODoc.HasFile)
                {
                    objPO.Uploaded_File = "DPO_" + txtPONo.Text.ToString() + ".pdf";
                }
                ...
                if (objPO.update(con, PurchaseOrderBL.eLoadSp.UPDATE))
                {
                    if (fuDPODoc.HasFile)
                    {
                        fuDPODoc.SaveAs(Server.MapPath("~\\UploadedFiles\\DPO_" + txtPONo.Text.Replace("/", "-") + ".pdf"));
                        lnkDownloadFile.Text = "DPO_" + txtPONo.Text + ".pdf";
    ...
    protected void btnCancel_Click(object sender, EventArgs e)
    {
        try
        {
            Response.Redirect("../Procurement/DirectPurchaseOrderList.aspx", false);
        }
        catch (Exception ex)
        {
            ErrorLogger.logError(ErrorLogger.enumErrorTypes.AppLogicError, ex, this.Page.ToString(), System.Reflection.MethodBase.GetCurrentMethod().Name, Session["UID"] != null ? Session["UID"].ToString() : string.Empty);
    ...
    protected void btnApprove_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            objPO.Task = "UpdateApprovelStatus";
            objPO.PONo = Request.QueryString["PONo"];
            objPO.Approver_Com = txtApproverComments.Text;
            if (objPO.load(con, PurchaseOrderBL.eLoadSp.UPDATE_APROVEL_STAUSDPO))
            {
    ...
    protected void ddlItemrfq_SelectedIndexChanged(object sender, EventArgs e)
    {
        try
        {
            objIndent = new IndentBL();
    ...
    protected void btnSaveItem_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            objPO.Mat_Cat_Id = Convert.ToInt32(ddlCategory.SelectedValue);
            objPO.Item_Code = ddlItem.SelectedValue;
            ...
            {
                objPO.Qty = Convert.ToDecimal(txtQty.Text);
            }
            ...
            {
                objPO.Price = Convert.ToDecimal(txtPrice.Text);
            }
            objPO.Amount = (Convert.ToDecimal(txtPrice.Text)) * (Convert.ToDecimal(txtQty.Text));
            objPO.Igst_Perc = Convert.ToDecimal(txtIgstPerc.Text.Trim());
            objPO.Cgst_Perc = Convert.ToDecimal(txtCgstPerc.Text.Trim());
            objPO.Sgst_Perc = Convert.ToDecimal(txtSgstPerc.Text.Trim());

            if (btnSaveItem.Text == "Save")
            {
                objPO.Task = "InsertPOItem";
                if (objPO.DirectPOItemInsertUpdate(con, PurchaseOrderBL.eLoadSp.INSERT_DIRECT_PO_ITEM))
                {
                    BindPOItems();
                    ScriptManager.RegisterStartupScript(this, GetType(), "CustomAlert", "Alert.render('PO Item has been added successfully');", true);
                    Clear();
                }
                else
                {
                    ScriptManager.RegisterStartupScript(this, GetType(), "CustomAlert1", "Alert1.render('This Item already exists for this PO.!!!');", true);
                }
            }
            else
            {
                objPO.Task = "UpdatePOItem";
                objPO.PO_Item_Id = Convert.ToInt32(Session["PO_Item_Id"]);
                if (objPO.DirectPOItemInsertUpdate(con, PurchaseOrderBL.eLoadSp.UPDATE_DIRECT_PO_ITEM))
                {
                    BindPOItems();
                    ScriptManager.RegisterStartupScript(this, GetType(), "CustomAlert", "Alert.render('PO Item details has been updated successfully');", true);
                    btnSaveItem.Text = "Save";
                    lblAddItems.Text = "Add Item";
                    Clear();
                }
                ...
                {
                    ScriptManager.RegisterStartupScript(this, GetType(), "CustomAlert1", "Alert1.render('Failed to update the PO Item details');", true);
                }
            }
            ModelItemPopup.Hide();
        }
    ...
    private void BindPOItems()
    {
        try
        {
            ...
            Total_Amount = 0;
            Grid_DirectPOItem.DataSource = ds;
            Grid_DirectPOItem.DataBind();
        }
        catch (Exception ex)
        {
            ErrorLogger.logError(ErrorLogger.enumErrorTypes.DBSelectError, ex, this.Page.ToString(), System.Reflection.MethodBase.GetCurrentMethod().Name, Session["UID"] != null ? Session["UID"].ToString() : string.Empty);
    ...
    protected void Grid_DirectPOItem_RowDataBound(object sender, Obout.Grid.GridRowEventArgs e)
    {
        try
        {
    ...
    protected void Grid_DirectPOItem_DeleteCommand(object sender, Obout.Grid.GridRecordEventArgs e)
    {
        try
        {
            objPO = new PurchaseOrderBL();
            objPO.PO_Item_Id = Convert.ToInt32(e.Record["PO_Item_Id"]);
            objPO.Task = "DeletePOItem";
            if (objPO.DirectPOItemInsertUpdate(con, PurchaseOrderBL.eLoadSp.DELETE_DIRECT_PO_ITEM))
            {
                BindPOItems();
    ...
    protected void lnkWOItem_Click(object sender, EventArgs e)
    {
        try
        {
            objPO = new PurchaseOrderBL();
            ds = new DataSet();
            objPO.PO_Item_Id = Convert.ToInt32(((LinkButton)sender).CommandName);
            Session["DPR_Item_Id"] = Convert.ToInt32(((LinkButton)sender).CommandName);
            if (objPO.load(con, PurchaseOrderBL.eLoadSp.SELECT_PO_ITEM_BY_ITEM_ID, ref ds))
            {
                ...
                txtIgstPerc.Text = ds.Tables[0].Rows[0]["Igst_Perc"].ToString() == "" ? "0.00" : ds.Tables[0].Rows[0]["Igst_Perc"].ToString();
                txtIgstAmt.Text = ds.Tables[0].Rows[0]["Igst_Amt"].ToString() == "" ? "0.00" : ds.Tables[0].Rows[0]["Igst_Amt"].ToString();
                txtCgstPerc.Text = ds.Tables[0].Rows[0]["Cgst_Perc"].ToString() == "" ? "0.00" : ds.Tables[0].Rows[0]["Cgst_Perc"].ToString();
                txtCgstAmt.Text = ds.Tables[0].Rows[0]["Cgst_Amt"].ToString() == "" ? "0.00" : ds.Tables[0].Rows[0]["Cgst_Amt"].ToString();
                txtSgstPerc.Text = ds.Tables[0].Rows[0]["Sgst_Perc"].ToString() == "" ? "0.00" : ds.Tables[0].Rows[0]["Sgst_Perc"].ToString();
                txtSgstAmt.Text = ds.Tables[0].Rows[0]["Sgst_Amt"].ToString() == "" ? "0.00" : ds.Tables[0].Rows[0]["Sgst_Amt"].ToString();
    ...
    protected void lnkRFQItem_Click(object sender, EventArgs e)
    {
        try
        {
            objRFQ = new RequestForquotationBL();
            ...
            if (objRFQ.load(con, RequestForquotationBL.eLoadSp.SELECT_RFQ_ITEM_BY_ITEM_ID, ref ds))
            {
                ...
                ddlCategory.SelectedValue = ds.Tables[0].Rows[0]["Mat_Cat_Id"].ToString().Trim();
                ddlCategoryrfq_SelectedIndexChanged(null, null);
                ddlItem.SelectedValue = ds.Tables[0].Rows[0]["Item_Code"].ToString();
                //txtUOMrfq.Text = "";
                txtmatcatid.Text = ds.Tables[0].Rows[0]["RFQ_Item_Id"].ToString();
                txtUOMrfq.Text = ds.Tables[0].Rows[0]["UOM"].ToString();
                txtQtyrfq.Text = ds.Tables[0].Rows[0]["Qty_required"].ToString();
                txtPricerfq.Text = ds.Tables[0].Rows[0]["Rate"].ToString();
                txtAmountrfq.Text = ds.Tables[0].Rows[0]["Amount"].ToString();

                txtIgstPercrfq.Text = ds.Tables[0].Rows[0]["Igstrfq_Perc"].ToString() == "" ? "0.00" : ds.Tables[0].Rows[0]["Igstrfq_Perc"].ToString();
                txtIgstAmtrfq.Text = ds.Tables[0].Rows[0]["Igst_Amtrfq"].ToString() == "" ? "0.00" : ds.Tables[0].Rows[0]["Igstrfq_Amt"].ToString();
                txtCgstPercrfq.Text = ds.Tables[0].Rows[0]["Cgstrfq_Perc"].ToString() == "" ? "0.00" : ds.Tables[0].Rows[0]["Cgstrfq_Perc"].ToString();
                txtCgstAmtrfq.Text = ds.Tables[0].Rows[0]["Cgstrfq_Amt"].ToString() == "" ? "0.00" : ds.Tables[0].Rows[0]["Cgstrfq_Amt"].ToString();
                txtSgstPercrfq.Text = ds.Tables[0].Rows[0]["Sgstrfq_Perc"].ToString() == "" ? "0.00" : ds.Tables[0].Rows[0]["Sgstrfq_Perc"].ToString();
                txtSgstAmt.Text = ds.Tables[0].Rows[0]["Sgstrfq_Amt"].ToString() == "" ? "0.00" : ds.Tables[0].Rows[0]["Sgstrfq_Amt"].ToString();
                btnSaveItemrfq.Text = "Update";
                ModelRFQItemPopup.Show();
            }
        }
        catch (Exception ex)
        {
    ...
    protected void btnSaveItemrfq_Click(object sender, EventArgs e)
    {
        try
        {
            objRFQ = new RequestForquotationBL();
            ...
            objRFQ.Qty = Convert.ToDecimal(txtQtyrfq.Text);

            if (txtPricerfq.Text == string.Empty || txtPricerfq.Text == "0")
            {
                ScriptManager.RegisterStartupScript(this, GetType(), "CustomAlert1", "Alert1.render('Please Enter Price');", true);
                return;
            }
            ...
            {
                objRFQ.Price = Convert.ToDecimal(txtPricerfq.Text);
            }
            objRFQ.Amountrfq = (Convert.ToDecimal(txtPricerfq.Text)) * (Convert.ToDecimal(txtQtyrfq.Text));
            objRFQ.Igstrfq_Perc = Convert.ToDecimal(txtIgstPercrfq.Text.Trim());
            objRFQ.Cgstrfq_Perc = Convert.ToDecimal(txtCgstPercrfq.Text.Trim());
            objRFQ.Sgstrfq_Perc = Convert.ToDecimal(txtSgstPercrfq.Text.Trim());

            if (btnSaveItemrfq.Text == "Save")
            {
            ...
            else
            {
                ...
                //Session["conID"] = (e.FindControl("RFQ_Item_Id") as Label).Text;
                //Session["DPR_Item_Id"] = Convert.ToInt32(((LinkButton)sender).CommandName);
                //objRFQ.RFQ_Item_Id = Convert.ToInt32(((LinkButton)sender).CommandName);

                // objRFQ.RFQ_Item_Id = Convert.ToInt32(Session["RFQ_Item_Id"]);
                //ds = new DataSet();
                //ViewState["RFQID"] = ds.Tables[0].Rows[0]["RFQ_ID"].ToString();
                //objRFQ = new RequestForquotationBL();
                ...
                //objRFQ.RFQ_Item_Id = Convert.ToInt32(ViewState["RFQ_Item_Id"]);
                objRFQ.RFQ_Item_Id = Convert.ToInt32(txtmatcatid.Text);
    ...
    protected void btnCancelItemrfq_Click(object sender, EventArgs e)
    {
        Clear();
        //lblAddItems.Text = "Add Item";
        btnSaveItem.Text = "Save";
        ModelItemPopup.Hide();
        //txtQty.Enabled = true;
        txtPricerfq.Enabled = true;
    }

    protected void ddlCategoryrfq_SelectedIndexChanged(object sender, EventArgs e)
    {
        try
        {
            if (ddlCategory.SelectedIndex != 0)
    ...
    protected void Grid_DirectRFQItem_RowDataBound(object sender, Obout.Grid.GridRowEventArgs e)
    {
        ...
        if (objRFQ.RFQNo != "" && objRFQ.RFQNo != "-Select-")
        {
            try
            {
                //if (e.Row.RowType == Obout.Grid.GridRowType.DataRow)
                ...
                //    e.Row.Cells[8].Text = Total_Sgst.ToString();
                //    Total_Amount_WithTax = Total_Amount + Total_Igst + Total_Cgst + Total_Sgst;
                //    txtTotalRFQ.Text = Total_Amount_WithTax.ToString();
    ...
    protected void btnSaveTax_Click(object sender, EventArgs e)
    {
        try
        {
            objPO = new PurchaseOrderBL();
            objPO.PONo = txtPONo.Text;
            objPO.TaxType = rbtntype.SelectedValue;
            if (rbtntype.SelectedValue == "IGST")
            {
                objPO.Igst_Perc = Convert.ToDecimal(txtIgstPercPO.Text.Trim());
                objPO.Igst_Amt = Convert.ToDecimal(txtTotal.Text.Trim()) * Convert.ToDecimal(txtIgstPercPO.Text.Trim()) / 100;
            }
            else if (rbtntype.SelectedValue == "CGST")
            {
                objPO.Cgst_Perc = Convert.ToDecimal(txtCgstPercPO.Text.Trim());
                objPO.Cgst_Amt = Convert.ToDecimal(txtTotal.Text.Trim()) * Convert.ToDecimal(txtCgstPercPO.Text.Trim()) / 100;
            }
            else if (rbtntype.SelectedValue == "SGST")
            {
                objPO.Sgst_Perc = Convert.ToDecimal(txtSgstPercPO.Text.Trim());
                objPO.Sgst_Amt = Convert.ToDecimal(txtTotal.Text.Trim()) * Convert.ToDecimal(txtSgstPercPO.Text.Trim()) / 100;
            }
            else if (rbtntype.SelectedValue == "PackingForwardingCost")
            {
                objPO.PackingCost = Convert.ToDecimal(txtPackingCost.Text.Trim());
            }
            else if (rbtntype.SelectedValue == "Transport")
            {
                objPO.TransportCost = Convert.ToDecimal(txtTransportCost.Text.Trim());
            }

            if (btnSaveTax.Text == "Save")
            {
                objPO.Task = "InsertPOTax";
                if (objPO.DirectPOTaxInsertUpdate(con, PurchaseOrderBL.eLoadSp.INSERT_DIRECT_PO_TAX))
                {
    ...
    private void BindPOTax()
    {
        try
        {
            ...
            Grid_DirectPOTax.DataSource = ds;
            Grid_DirectPOTax.DataBind();
        }
        catch (Exception ex)
        {
            ErrorLogger.logError(ErrorLogger.enumErrorTypes.DBSelectError, ex, this.Page.ToString(), System.Reflection.MethodBase.GetCurrentMethod().Name, Session["UID"] != null ? Session["UID"].ToString() : string.Empty);
    ...
    protected void Grid_DirectPOTax_DeleteCommand(object sender, Obout.Grid.GridRecordEventArgs e)
    {
        try
        {
            objPO = new PurchaseOrderBL();
            objPO.PO_Tax_ID = Convert.ToInt32(e.Record["PO_Tax_Id"]);
            objPO.Task = "DeletePOTax";
            if (objPO.DirectPOTaxInsertUpdate(con, PurchaseOrderBL.eLoadSp.DELETE_DIRECT_PO_TAX))
            {
                BindPOTax();
                ScriptManager.RegisterStartupScript(this, GetType(), "CustomAlert", "Alert.render('PO Tax has been deleted sucessfully.');", true);
            }
