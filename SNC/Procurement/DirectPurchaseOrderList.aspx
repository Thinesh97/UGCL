<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/SNC.Master" AutoEventWireup="true" CodeBehind="~/Procurement/DirectPurchaseOrderList.aspx.cs" Inherits="DirectPurchaseOrderList" %>
    ...
    <div class="panel panel-default">
        <div class="panel-heading">
            ...
            <h3 class="panel-title">
                ...
                Direct Purchase Order List

            </h3>

        </div>
        <div class="panel-body">
             <h4 style="text-align:center"> Pending Direct Purchase Orders </h4>
             <center>
        <ogrid:Grid runat="server" ID="Grid_PO_Pending" CallbackMode="false" AutoGenerateColumns="false" 
            OnRowDataBound="Grid_PO_RowDataBound_Pending" 
            ...
            <Columns>
                <ogrid:Column DataField="PONo" HeaderText="PO No" Width="200px" >
                     <TemplateSettings  TemplateId="GridDPO_Pending"/>
                </ogrid:Column>
            ...
            <Templates>
                <ogrid:GridTemplate ID="GridDPO_Pending" runat="server">
                    <Template>
        ...
        <br />
                <center>
                    <a href="DirectPurchaseOrder.aspx" runat="server" id="A1" class="btn btn-default">Add New Direct PO</a>               
                    ...
                    <asp:Button ID="Button2"  runat="server" Text="Generate PO Items List"  OnClick="btn_GenPOItemsList_Click" CssClass="btn btn-default"/>   
                </center>
            </center>
        ...
        <br />
                <center>
                    <a href="DirectPurchaseOrder.aspx" runat="server" id="lnkbtnAdd" class="btn btn-default">Add New Direct PO</a>               
