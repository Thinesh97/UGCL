...
public partial class PSOPrint : System.Web.UI.Page
{
    ...
    private void GetPSODetails(string PSONo)
    {
        ...
        if (ds.Tables[0].Rows.Count > 0)
        {
            lblPSONo.Text = ds.Tables[0].Rows[0]["PSONo"].ToString();
            lblPSONo2.Text = ds.Tables[0].Rows[0]["PSONo"].ToString();
            lblPSODate.Text = ds.Tables[0].Rows[0]["PSODate"].ToString();
            ...
            lblPSONo1.Text = ds.Tables[0].Rows[0]["PSONo"].ToString();
            lblPSODate1.Text = ds.Tables[0].Rows[0]["PSODate"].ToString();
            ...
            lblPSONo3.Text = ds.Tables[0].Rows[0]["PSONo"].ToString();
            lblPSODate2.Text = ds.Tables[0].Rows[0]["PSODate"].ToString();
            ...
            ViewState["PSOID"] = ds.Tables[0].Rows[0]["PSO_ID"].ToString();
        }
    ...
    private void BindPSOItems()
    {
        try
        {
            ...
            objPSO.PSO_ID = Convert.ToString(ViewState["PSOID"]);
            objPSO.Task = "GetPSOItemDetails";
            objPSO.load(con, ProfessionalServiceOrderBL.eLoadSp.SELECT_PSO_ITEMS_BY_PSONO_FOR_PRINT, ref ds);
            PSO_ItemCount = ds.Tables[0].Rows.Count;
            int i = 0;
            ...
            foreach (DataRow row in ds.Tables[0].Rows)
            {
                if (i < 5)
                {
                    ...
                    lblPageNo1.Text = "1 of 17";
                    lblPageNo3.Text = "2 of 17";
                    lblPageNo4.Text = "3 of 17";
                    lblPageNo5.Text = "4 of 17";
                    lblPageNo6.Text = "5 of 17";
                    lblPageNo7.Text = "6 of 17";
                    lblPageNo8.Text = "7 of 17";
                    lblPageNo9.Text = "8 of 17";
                    lblPageNo10.Text = "9 of 17";
                    lblPageNo11.Text = "10 of 17";
                    lblPageNo12.Text = "11 of 17";
                    lblPageNo13.Text = "12 of 17";
                    lblPageNo14.Text = "13 of 17";
                    lblPageNo15.Text = "14 of 17";
                    lblPageNo16.Text = "15 of 17";
                    lblPageNo17.Text = "16 of 17";
                    lblPageNo18.Text = "17 of 17";
                ...
                else
                {
                    ...
                    lblPageNo2.Text = "2 of 18";
                    lblPageNo3.Text = "3 of 18";
                    lblPageNo4.Text = "4 of 18";
                    lblPageNo5.Text = "5 of 18";
                    lblPageNo6.Text = "6 of 18";
                    lblPageNo7.Text = "7 of 18";
                    lblPageNo8.Text = "8 of 18";
                    lblPageNo9.Text = "9 of 18";
                    lblPageNo10.Text = "10 of 18";
                    lblPageNo11.Text = "11 of 18";
                    lblPageNo12.Text = "12 of 18";
                    lblPageNo13.Text = "13 of 18";
                    lblPageNo14.Text = "14 of 18";
                    lblPageNo15.Text = "15 of 18";
                    lblPageNo16.Text = "16 of 18";
                    lblPageNo17.Text = "17 of 18";
                    lblPageNo18.Text = "18 of 18";
    ...
    private void BindSOWItems()
    {
        try
        {
            ...
            if (ds.Tables[0].Rows.Count <= 0)
            {
                lblAnnexure.Text = "Annexure A,B & C Are Integral Part of This Professinal Service Order";
                lblAnnexure1.Text = "Annexure A,B & C Are Integral Part of This Professinal Service Order";
            }
            else
            {
                lblAnnexure.Text = "Annexure A,B,C & D Are Integral Part of This Professinal Service Order";
                lblAnnexure1.Text = "Annexure A,B,C & D Are Integral Part of This Professinal Service Order";
            }
        }
        catch (Exception ex)
        {
    ...
    private void AssignPageNumber()
    {
        try
        {
            if (PSO_ItemCount < 6 && SOW_ItemCount < 1)
            {
                lblPageNo1.Text = "1 of 17";
                lblPageNo3.Text = "2 of 17";
                lblPageNo4.Text = "3 of 17";
            ...
            else if (PSO_ItemCount < 6 && (SOW_ItemCount <= 20 && SOW_ItemCount >= 1))
            {
                lblPageNo1.Text = "1 of 18";
                ...
                //lblPageNo19.Text = "18 of 20";
                //lblPageNo20.Text = "19 of 20";
                lblPageNo21.Text = "18 of 18";
            }

            else if (PSO_ItemCount < 6 && SOW_ItemCount >= 20)
            {
                ...
                //lblPageNo19.Text = "18 of 19";
                //lblPageNo20.Text = "19 of 19";
                lblPageNo21.Text = "18 of 19";
                lblPageNo22.Text = "19 of 19";
            }
            else if (PSO_ItemCount >= 6 && SOW_ItemCount >= 20)
            {
                if (SOW_ItemCount >= 18)
                ...
                if (SOW_ItemCount >= 36)
                {
                    ...
                    lblPageNo21.Text = "19 of 21";
                    lblPageNo22.Text = "20 of 21";
                    lblPageNo23.Text = "21 of 21";
                ...
                if (SOW_ItemCount >= 54)
                {
                    ...
                    //lblPageNo20.Text = "20 of 22";
                    lblPageNo21.Text = "19 of 22";
                    lblPageNo22.Text = "20 of 22";
                    lblPageNo23.Text = "21 of 22";
                    lblPageNo24.Text = "22 of 22";
                ...
                if (SOW_ItemCount >= 72)
                {
                    ...
                    lblPageNo21.Text = "19 of 23";
                    lblPageNo22.Text = "20 of 23";
                    lblPageNo23.Text = "21 of 23";
                    lblPageNo24.Text = "22 of 23";
                    lblPageNo25.Text = "23 of 23";
                }
                if (SOW_ItemCount >= 90)
                {
                    ...
                    lblPageNo21.Text = "19 of 24";
                    lblPageNo22.Text = "20 of 24";
                    lblPageNo23.Text = "21 of 24";
                    lblPageNo24.Text = "22 of 24";
                    lblPageNo25.Text = "23 of 24";
                    lblPageNo26.Text = "24 of 24";
                ...
                if (SOW_ItemCount >= 108)
                {
                    ...
                    lblPageNo21.Text = "19 of 25";
                    lblPageNo22.Text = "20 of 25";
                    lblPageNo23.Text = "21 of 25";
                    lblPageNo24.Text = "22 of 25";
                    lblPageNo25.Text = "23 of 25";
                    lblPageNo26.Text = "24 of 25";
                    lblPageNo27.Text = "25 of 25";
                ...
                if (SOW_ItemCount >= 126)
                {
                    ...
                    lblPageNo21.Text = "19 of 26";
                    lblPageNo22.Text = "20 of 26";
                    lblPageNo23.Text = "21 of 26";
                    lblPageNo24.Text = "22 of 26";
                    lblPageNo25.Text = "23 of 26";
                    lblPageNo26.Text = "24 of 26";
                    lblPageNo27.Text = "25 of 26";
                    lblPageNo28.Text = "26 of 26";
                }
                if (SOW_ItemCount >= 144)
                {
                    ...
                    lblPageNo21.Text = "19 of 27";
                    lblPageNo22.Text = "20 of 27";
                    lblPageNo23.Text = "21 of 27";
                    lblPageNo24.Text = "22 of 27";
                    lblPageNo25.Text = "23 of 27";
                    lblPageNo26.Text = "24 of 27";
                    lblPageNo27.Text = "25 of 27";
                    lblPageNo28.Text = "26 of 27";
                    lblPageNo29.Text = "27 of 27";
                }
                ...
                if (SOW_ItemCount >= 162)
                {
                    ...
                    lblPageNo21.Text = "19 of 28";
                    lblPageNo22.Text = "20 of 28";
                    lblPageNo23.Text = "21 of 28";
                    lblPageNo24.Text = "22 of 28";
                    lblPageNo25.Text = "23 of 28";
                    lblPageNo26.Text = "24 of 28";
                    lblPageNo27.Text = "25 of 28";
                    lblPageNo28.Text = "26 of 28";
                    lblPageNo29.Text = "27 of 28";
                    lblPageNo30.Text = "28 of 28";
                }
                if (SOW_ItemCount >= 180)
                {
                    ...
                    lblPageNo21.Text = "19 of 29";
                    lblPageNo22.Text = "20 of 29";
                    lblPageNo23.Text = "21 of 29";
                    lblPageNo24.Text = "22 of 29";
                    lblPageNo25.Text = "23 of 29";
                    lblPageNo26.Text = "24 of 29";
                    lblPageNo27.Text = "25 of 29";
                    lblPageNo28.Text = "26 of 29";
                    lblPageNo29.Text = "27 of 29";
                    lblPageNo30.Text = "28 of 29";
                    lblPageNo31.Text = "29 of 29";
                }
                if (SOW_ItemCount >= 198)
                {
                    ...
                    lblPageNo21.Text = "19 of 30";
                    lblPageNo22.Text = "20 of 30";
                    lblPageNo23.Text = "21 of 30";
                    lblPageNo24.Text = "22 of 30";
                    lblPageNo25.Text = "23 of 30";
                    lblPageNo26.Text = "24 of 30";
                    lblPageNo27.Text = "25 of 30";
                    lblPageNo28.Text = "26 of 30";
                    lblPageNo29.Text = "27 of 30";
                    lblPageNo30.Text = "28 of 30";
                    lblPageNo31.Text = "29 of 30";
                    lblPageNo32.Text = "30 of 30";
                }
                if (SOW_ItemCount >= 216)
                {
                    ...
                    lblPageNo21.Text = "19 of 31";
                    lblPageNo22.Text = "20 of 31";
                    lblPageNo23.Text = "21 of 31";
                    lblPageNo24.Text = "22 of 31";
                    lblPageNo25.Text = "23 of 31";
                    lblPageNo26.Text = "24 of 31";
                    lblPageNo27.Text = "25 of 31";
                    lblPageNo28.Text = "26 of 31";
                    lblPageNo29.Text = "27 of 31";
                    lblPageNo30.Text = "28 of 31";
                    lblPageNo31.Text = "29 of 31";
                    lblPageNo32.Text = "30 of 31";
                    lblPageNo33.Text = "31 of 31";
                }
                if (SOW_ItemCount >= 234)
                {
                    ...
                    lblPageNo21.Text = "19 of 32";
                    lblPageNo22.Text = "20 of 32";
                    lblPageNo23.Text = "21 of 32";
                    lblPageNo24.Text = "22 of 32";
                    lblPageNo25.Text = "23 of 32";
                    lblPageNo26.Text = "24 of 32";
                    lblPageNo27.Text = "25 of 32";
                    lblPageNo28.Text = "26 of 32";
                    lblPageNo29.Text = "27 of 32";
                    lblPageNo30.Text = "28 of 32";
                    lblPageNo31.Text = "29 of 32";
                    lblPageNo32.Text = "30 of 32";
                    lblPageNo33.Text = "31 of 32";
                    lblPageNo34.Text = "32 of 32";
                }
                if (SOW_ItemCount >= 252)
                {
                    ...
                    lblPageNo21.Text = "19 of 33";
                    lblPageNo22.Text = "20 of 33";
                    lblPageNo23.Text = "21 of 33";
                    lblPageNo24.Text = "22 of 33";
                    lblPageNo25.Text = "23 of 33";
                    lblPageNo26.Text = "24 of 33";
                    lblPageNo27.Text = "25 of 33";
                    lblPageNo28.Text = "26 of 33";
                    lblPageNo29.Text = "27 of 33";
                    lblPageNo30.Text = "28 of 33";
                    lblPageNo31.Text = "29 of 33";
                    lblPageNo32.Text = "30 of 33";
                    lblPageNo33.Text = "31 of 33";
                    lblPageNo34.Text = "32 of 33";
                    lblPageNo35.Text = "33 of 33";
                }
                if (SOW_ItemCount >= 270)
                {
                    ...
                    lblPageNo21.Text = "19 of 34";
                    lblPageNo22.Text = "20 of 34";
                    lblPageNo23.Text = "21 of 34";
                    lblPageNo24.Text = "22 of 34";
                    lblPageNo25.Text = "23 of 34";
                    lblPageNo26.Text = "24 of 34";
                    lblPageNo27.Text = "25 of 34";
                    lblPageNo28.Text = "26 of 34";
                    lblPageNo29.Text = "27 of 34";
                    lblPageNo30.Text = "28 of 34";
                    lblPageNo31.Text = "29 of 34";
                    lblPageNo32.Text = "30 of 34";
                    lblPageNo33.Text = "31 of 34";
                    lblPageNo34.Text = "32 of 34";
                    lblPageNo35.Text = "33 of 34";
                    lblPageNo36.Text = "34 of 34";
                }
                if (SOW_ItemCount >= 288)
                {
                    ...
                    lblPageNo21.Text = "19 of 35";
                    lblPageNo22.Text = "20 of 35";
                    lblPageNo23.Text = "21 of 35";
                    lblPageNo24.Text = "22 of 35";
                    lblPageNo25.Text = "23 of 35";
                    lblPageNo26.Text = "24 of 35";
                    lblPageNo27.Text = "25 of 35";
                    lblPageNo28.Text = "26 of 35";
                    lblPageNo29.Text = "27 of 35";
                    lblPageNo30.Text = "28 of 35";
                    lblPageNo31.Text = "29 of 35";
                    lblPageNo32.Text = "30 of 35";
                    lblPageNo33.Text = "31 of 35";
                    lblPageNo34.Text = "32 of 35";
                    lblPageNo35.Text = "33 of 35";
                    lblPageNo36.Text = "34 of 35";
                    lblPageNo37.Text = "35 of 35";
                }
                if (SOW_ItemCount >= 306)
                {
                    ...
                    lblPageNo21.Text = "19 of 36";
                    lblPageNo22.Text = "20 of 36";
                    lblPageNo23.Text = "21 of 36";
                    lblPageNo24.Text = "22 of 36";
                    lblPageNo25.Text = "23 of 36";
                    lblPageNo26.Text = "24 of 36";
                    lblPageNo27.Text = "25 of 36";
                    lblPageNo28.Text = "26 of 36";
                    lblPageNo29.Text = "27 of 36";
                    lblPageNo30.Text = "28 of 36";
                    lblPageNo31.Text = "29 of 36";
                    lblPageNo32.Text = "30 of 36";
                    lblPageNo33.Text = "31 of 36";
                    lblPageNo34.Text = "32 of 36";
                    lblPageNo35.Text = "33 of 36";
                    lblPageNo36.Text = "34 of 36";
                    lblPageNo37.Text = "35 of 36";
                    lblPageNo38.Text = "36 of 36";
                }
                if (SOW_ItemCount >= 324)
                {
                    ...
                    lblPageNo21.Text = "19 of 37";
                    lblPageNo22.Text = "20 of 37";
                    lblPageNo23.Text = "21 of 37";
                    lblPageNo24.Text = "22 of 37";
                    lblPageNo25.Text = "23 of 37";
                    lblPageNo26.Text = "24 of 37";
                    lblPageNo27.Text = "25 of 37";
                    lblPageNo28.Text = "26 of 37";
                    lblPageNo29.Text = "27 of 37";
                    lblPageNo30.Text = "28 of 37";
                    lblPageNo31.Text = "29 of 37";
                    lblPageNo32.Text = "30 of 37";
                    lblPageNo33.Text = "31 of 37";
                    lblPageNo34.Text = "32 of 37";
                    lblPageNo35.Text = "33 of 37";
                    lblPageNo36.Text = "34 of 37";
                    lblPageNo37.Text = "35 of 37";
                    lblPageNo38.Text = "36 of 37";
                    lblPageNo39.Text = "37 of 37";
                }
                if (SOW_ItemCount >= 360)
                {
                    ...
                    lblPageNo21.Text = "19 of 38";
                    lblPageNo22.Text = "20 of 38";
                    lblPageNo23.Text = "21 of 38";
                    lblPageNo24.Text = "22 of 38";
                    lblPageNo25.Text = "23 of 38";
                    lblPageNo26.Text = "24 of 38";
                    lblPageNo27.Text = "25 of 38";
                    lblPageNo28.Text = "26 of 38";
                    lblPageNo29.Text = "27 of 38";
                    lblPageNo30.Text = "28 of 38";
                    lblPageNo31.Text = "29 of 38";
                    lblPageNo32.Text = "30 of 38";
                    lblPageNo33.Text = "31 of 38";
                    lblPageNo34.Text = "32 of 38";
                    lblPageNo35.Text = "33 of 38";
                    lblPageNo36.Text = "34 of 38";
                    lblPageNo37.Text = "35 of 38";
                    lblPageNo38.Text = "36 of 38";
                    lblPageNo39.Text = "37 of 38";
                    lblPageNo40.Text = "38 of 38";
                }
                if (SOW_ItemCount >= 378)
                {
                    ...
                    lblPageNo21.Text = "19 of 39";
                    lblPageNo22.Text = "20 of 39";
                    lblPageNo23.Text = "21 of 39";
                    lblPageNo24.Text = "22 of 39";
                    lblPageNo25.Text = "23 of 39";
                    lblPageNo26.Text = "24 of 39";
                    lblPageNo27.Text = "25 of 39";
                    lblPageNo28.Text = "26 of 39";
                    lblPageNo29.Text = "27 of 39";
                    lblPageNo30.Text = "28 of 39";
                    lblPageNo31.Text = "29 of 39";
                    lblPageNo32.Text = "30 of 39";
                    lblPageNo33.Text = "31 of 39";
                    lblPageNo34.Text = "32 of 39";
                    lblPageNo35.Text = "33 of 39";
                    lblPageNo36.Text = "34 of 39";
                    lblPageNo37.Text = "35 of 39";
                    lblPageNo38.Text = "36 of 39";
                    lblPageNo39.Text = "37 of 39";
                    lblPageNo40.Text = "38 of 39";
                    lblPageNo41.Text = "39 of 39";
                }
            ...
            else if (PSO_ItemCount >= 6 && (SOW_ItemCount < 20 && SOW_ItemCount != 0))
            {
                lblPageNo1.Text = "1 of 19";
