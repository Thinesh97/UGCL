<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/SNC_Print.Master" AutoEventWireup="true" CodeBehind="PaymentIndent_PO_Print.aspx.cs" Inherits="PaymentIndent_PO_Print" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="divToPrint1a" runat="server">
        ...
        <div id="divTableDataHolder1a" style="width: 880px">
            ...
            <div style="text-align: right; padding-right: 30px">
                <b>Page No:
                    <asp:Label runat="server" ID="lblPageNo1a"></asp:Label></b>
            </div>
            <div class="mypageadjust">
                ...
                <table class="table table-bordered" style="width: 97%; margin-bottom: 0px;" id="mytbl1">
                    <tr>
                        ...
                        <td style="width: 25%">Purchase Order No. :<br />
                            <b>
                                <asp:Label runat="server" Text="" ID="lblPONo1"></asp:Label></b>
                        </td>
                    ...
                    <tr>
                        <td rowspan="3" style="width: 50%"><b><u>Dispatch To : </u></b>
                            <br />
                            <b>United Global Corporation Limited</b>
                            <br />
                            Formerly Known As United Infra Corp. (BLR) Ltd.
                        ...
                        <asp:Label runat="server" Text="" ID="lblGSTIN_Company1"></asp:Label><br />
                            State Name :
                            <asp:Label runat="server" Text="" ID="lblState_Company1"></asp:Label>, Code :
                            <asp:Label runat="server" Text="" ID="lblCode_Company1"></asp:Label>
                        </td>
                ...
                <table class="table table-bordered" style="width: 97%; padding: 0; margin-top: -1px;" id="mytbl3a" runat="server">
                    ...
                    <tr>
                        <td style="text-align: right; width: 55%; font-weight: bold">TAXABLE VALUE
                        </td>
                    ...
                    <tr>
                        <td style="text-align: right;">(-) TDS U/S 194 Q @ 0.1%
                        </td>
                        <td style="text-align: right">
                    ...
                    <tr>
                        <td style="text-align: right; width: 50%; font-weight: bold">NET PAYABLE
                        </td>
                        <td style="text-align: right">
                    ...
                    <tr>
                        <td colspan="3">Amount Chargeable (in words)<br />
                            <b>
                                <asp:Label runat="server" Text="" ID="lblAmountInWords1"></asp:Label></b>
                        </td>
                    </tr>
    ...
    <div id="divToPrint1b" runat="server">
        ...
        <div id="divTableDataHolder1b" style="width: 880px">
            ...
            <div style="text-align: right; padding-right: 30px">
                <b>Page No:
                    <asp:Label runat="server" ID="lblPageNo1b"></asp:Label></b>
            </div>
            <div class="mypageadjust">
                <b>PURCHASE ORDER -
                    <asp:Label runat="server" ID="lblPONo2"></asp:Label></b>
                ...
                <table class="table table-bordered" style="width: 97%; padding: 0; margin-top: -1px;" id="mytbl3b" runat="server">
                    ...
                    <tr>
                        <td colspan="3">Amount Chargeable (in words)<br />
                            <b>
                                <asp:Label runat="server" Text="" ID="lblAmountInWords2"></asp:Label></b>
                        </td>
                    </tr>
    ...
    <div id="divToPrint1c" runat="server">
        ...
        <div id="divTableDataHolder1c" style="width: 880px">
            ...
            <div style="text-align: right; padding-right: 30px">
                <b>Page No:
                    <asp:Label runat="server" ID="lblPageNo1c"></asp:Label></b>
            </div>
            <div class="mypageadjust">
                <b>PURCHASE ORDER -
                    <asp:Label runat="server" ID="lblPONo3"></asp:Label></b>
                ...
                <table class="table table-bordered" style="width: 97%; padding: 0; margin-top: -1px;" id="mytbl3c" runat="server">
                    ...
                    <tr>
                        <td colspan="3">Amount Chargeable (in words)<br />
                            <b>
                                <asp:Label runat="server" Text="" ID="lblAmountInWords3"></asp:Label></b>
                        </td>
                    </tr>
    ...
    <div id="divToPrint1d" runat="server">
        ...
        <div id="divTableDataHolder1d" style="width: 880px">
            ...
            <div style="text-align: right; padding-right: 30px">
                <b>Page No:
                    <asp:Label runat="server" ID="lblPageNo1d"></asp:Label></b>
            </div>
            <div class="mypageadjust">
                <b>PURCHASE ORDER -
                    <asp:Label runat="server" ID="lblPONo4"></asp:Label></b>
                ...
                <table class="table table-bordered" style="width: 97%; padding: 0; margin-top: -1px;" id="mytbl3d" runat="server">
                    ...
                    <tr>
                        <td colspan="3">Amount Chargeable (in words)<br />
                            <b>
                                <asp:Label runat="server" Text="" ID="lblAmountInWords4"></asp:Label></b>
                        </td>
                    </tr>
    ...
    <div id="divToPrint1e" runat="server">
        ...
        <div id="divTableDataHolder1e" style="width: 880px">
            ...
            <div style="text-align: right; padding-right: 30px">
                <b>Page No:
                    <asp:Label runat="server" ID="lblPageNo1e"></asp:Label></b>
            </div>
            <div class="mypageadjust">
                <b>PURCHASE ORDER -
                    <asp:Label runat="server" ID="lblPONo5"></asp:Label></b>
                ...
                <table class="table table-bordered" style="width: 97%; padding: 0; margin-top: -1px;" id="mytbl3e" runat="server">
                    ...
                    <tr>
                        <td colspan="3">Amount Chargeable (in words)<br />
                            <b>
                                <asp:Label runat="server" Text="" ID="lblAmountInWords5"></asp:Label></b>
                        </td>
                    </tr>
    ...
    <div id="divToPrint3">
        <div id="divTableDataHolder3" style="width: 880px">
            ...
            <div style="text-align: right; padding-right: 30px">
                <b>Page No:
                    <asp:Label runat="server" ID="lblPageNo3a"></asp:Label></b>
            </div>
...
in connection with this P.O unless expressly agreed by UGCL.
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <div style="text-align: right; padding-right: 30px">
                            <b>Page No:
                                <asp:Label runat="server" ID="lblPageNo3b"></asp:Label></b>
                        </div>
                    </td>
                </tr>
                <tr>
...
disputed in good faith until the parties reach an agreement with respect to such disputed amounts.
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <div style="text-align: right; padding-right: 30px">
                            <b>Page No:
                                <asp:Label runat="server" ID="lblPageNo3c"></asp:Label></b>
                        </div>
                    </td>
                </tr>
                <tr>
...
shall be:
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <div style="text-align: right; padding-right: 30px">
                            <b>Page No:
                                <asp:Label runat="server" ID="lblPageNo3d"></asp:Label></b>
                        </div>
                    </td>
                </tr>
                <tr>
