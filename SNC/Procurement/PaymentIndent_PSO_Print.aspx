<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/SNC_Print.Master" AutoEventWireup="true" CodeBehind="PaymentIndent_PSO_Print.aspx.cs" Inherits="PaymentIndent_PSO_Print" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <style>
        ...
        table#ContentPlaceHolder1_GridPrint3 tr td {
            text-align: center !important;
        }

            table#ContentPlaceHolder1_GridPrint3 tr td:last-child {
    ...
    <div id="divToPrint1" runat="server">
        ...
        <div id="divTableDataHolder1" style="width: 880px">
            ...
            <div style="width: 100%;">
                <img src="../Style/Images/HeaderImg.png" alt="PSO Header" style="width: 98%; height: 110px" />
            </div>
            ...
            <div class="mypageadjustfirst">
                ...
                <b>Professional Service Order</b>
                ...
                <table class="table table-bordered" style="width: 97%; margin-bottom: 0px;" id="mytbl1">
                    <tr>
                        ...
                        <td style="width: 25%">Professional Service Order No.<br />
                            <b>
                                <asp:Label runat="server" Text="" ID="lblPSONo"></asp:Label>
                            </b>
                        </td>
                        <td style="width: 25%">Dated<br />
                            <asp:Label runat="server" Text="" ID="lblPSODate"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td>Quotation ref./  Date<br />
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Description of Services" ItemStyle-Width="470px">
                                        <ItemTemplate>
                                            ...
                                            <asp:Label ID="lblItemDesc" Font-Size="13px" runat="server" Text='<%#Eval("PSO_Desc")%>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
            ...
            <div class="invoiceFooter">
                ...
                <img src="../Style/Images/FooterImg.png" alt="PSO Footer" style="height: 80px; width: 96%" />
            </div>
    ...
    <div id="divToPrint2" runat="server">
        ...
        <div id="divTableDataHolder2" style="width: 880px">
            ...
            <div class="mypageadjustfirst">
                <b>Professional Service Order -
                    <asp:Label runat="server" ID="lblPSONo2"></asp:Label></b>
            ...
            <div class="invoiceFooter" style="margin-top: 30px;">
                <p style="margin: 0;">This is a Computer Generated Document</p>
                <img src="../Style/Images/FooterImg.png" alt="PSO Footer" style="height: 80px; width: 97%" />
            </div>
    ...
    <div id="divToPrint4">
        <div id="divTableDataHolder4" style="width: 880px">
            ...
            <table border="0" style="width: 550px; font-weight: bold; border: 1px solid white">
                <tr>
                    <td style="width: 35%">GTC PSO Document No.</td>
                    <td style="width: 5%">:</td>
                    <td style="width: 60%">
                        <asp:Label runat="server" ID="lblPSONo1"></asp:Label></td>
                </tr>
                <tr>
                    <td>Contractor</td>
                    <td>:</td>
                ...
                <tr>
                    ...
                    <td>:</td>
                    <td>
                        <asp:Label runat="server" ID="lblPSODate1"></asp:Label></td>
                </tr>
            </table>
            <div class="instract">
                <p>
                    <b>United Global Corporation Ltd</b> has been entrusted  the  work  “<asp:Label runat="server" ID="lblProjectName"></asp:Label>” by the
                    <asp:Label runat="server" ID="lblPrincipalContractor"></asp:Label>
                    /
                    <asp:Label runat="server" ID="lblAward_By"></asp:Label>
                    .
                        <br />
                    These General Terms and Conditions are applicable to all Professional Service Orders issued by <b>M/s. United Global Corporation Ltd.</b> to <b>
                        <asp:Label runat="server" ID="lblSubcontractor1"></asp:Label>
                    </b>during  the tenure of the project and thereafter till defect liability period or O&M handover as applicable from  the  date  of  these  General  Terms  and  Conditions  stated  hereinabove  and shall be read in conjunction with the said Professional Service Order, the Special Conditions, Specifications, drawings and/or any other document attached to or enclosed with the Professional Service Order and shall form an integral and binding part of the Professional Service Order placed on the Subcontractor.
                        <br />
                    Each Professional Service Order, and other documents included therein or attached or enclosed with Professional Service Order, together with terms of these general terms and condition of Professional Service Order,constitutes a separate Professional Service Order Contract (hereinafter referred to as ‘Professional Service Order Contract’) that will be effective upon issue of  Professional Service Order to the Sub - Contractor with respect to performance of work as described in the Professional Service Order.
                        <br />
                    Each Professional Service Order shall be governed by the terms of these General Terms and Conditions of Professional Service Order. In the event of any conflict, discrepancy, inconsistency or ambiguity between the terms of these General Terms and Conditions of Professional Service Order and any other documents, than the priority shall be as follows: (1) Employer Professional Service Order & terms; (2) Other enclosure or Annexure or attachment to Professional Service Order; and (3) These General Terms and Conditions of Professional Service Order.
                        <br />
                    The Subcontractor shall return the copy of these General Terms & Conditions of Professional Service Order duly accepted without any deviations for further processing at Contractor’s end. The General Terms and conditions of Professional Service Order would be deemed to be accepted if signed and stamped acceptance/acknowledgement copy is not received within 4 working days the Subcontractor accepts the Professional Service Order or receives payments. Failure to return these General Terms & Conditions / Contract doesn't diminish Subcontractor’s responsibility of executing the services required as per the Professional Service Order Contract.
                        <br />
                    Contractor and Subcontractor shall hereinafter individually referred to as Party and collectively referred to as Parties.
                        <br />
                </p>
                <p>
                    <b>1.DEFINITIONS :</b>&nbsp; In these General Conditions and in any Professional Service Order   issued  by  Contractor  to  Subcontractor,  the following words and expressions shall have the meanings hereby assigned to them:
                        <br />
                    <b>ACCEPTED SUBCONTRACT AMOUNT :</b>&nbsp; ‘Accepted Subcontract Amount’ means either the Lump Sum Amount or the total sum derived from the multiplication of quantities of such item and its rates accepted by the Contractor and after deduction of all rebates/debits as per the Accepted Priced Bill of Quantities of the Subcontract stated in or enclosed with the Professional Service Order for the execution and completion of Work fit for the purpose including the remedying of defects therein in accordance with Clause 7 -   ‘The Scope of Work’ of these Conditions.
                        <br />
                    <b>APPLICABLE LAWS :</b>&nbsp; ‘Applicable Laws’ mean all laws, brought in to force and effect by Government of India or the State Government or the local bodies including rules, regulations and notifications made there under and judgments, decrees, injunctions, writs and orders of any court ofrecord, applicable to  the  Professional Service Order Contract  and the exercise, performance and discharge of the respective rights and obligations of the Parties hereunder, as may be in force and effect during the subsistence of to  the  Professional Service Order Contract   and shall include its statutory modifications, amendments, re- enactments, consolidations and substitutions as may be inforce from time to time
                        <br />
                ...
                <p>
                    ...
                    <b>CONTRACTOR’S ENGINEER:</b>&nbsp; ‘Contractor’s Engineer’ means the ‘Project In Charge’ of the Contractor and/or the person specifically appointed and authorized by the Contractor to act as Contractor’s Engineer for the purposes of the Professional Service Order or other person appointed from time to time by the Contractor and notified to the Subcontractor.
                        <br />
                </p>
            </div>
                ...
                <div class="pointinstrctcls">
                    <p>
                        ...
                        <b>SUB CONTRACTOR:</b>&nbsp; ‘Subcontractor’ means <span><b>
                            ...
                            -
                            <asp:Label ID="lblPinNo1" runat="server"></asp:Label></b> </span>whose offer has been accepted by the Contractor and named as Subcontractor in the Professional Service Order and includes Subcontractor’s legal heirs, representatives, successors the legal successors in title to this (these) person(s), but not (except with the prior written consent of the Contractor) any assignee of this (these) person(s).
                        <br />
                        <b>SUB CONTRACTOR’S DOCUMENTS:</b>&nbsp; ‘Subcontractor’s Documents’ mean the calculations, computer programs and other software, drawings, manuals, models and other documents of a technical nature, if any, supplied by the Subcontractor under the Professional Service Order.
                        <br />
                        ...
                        <br />
                        <b>TIME FOR COMPLETION:</b>&nbsp; Subcontractor’s ‘Time for Completion’ means the time for completing the Subcontract Works fit for the purpose or a Section/Milestone thereof (as the case may be) where Milestone completion dates are stipulated, as stated in the Professional Service Order and shall always include the mobilization period and monsoon period as well.
                        <br />
                        <b>Professional Service Order  CONTRACT :</b>&nbsp; ‘Professional Service Order  Contract’  shall mean and includes  (i)  Professional Service Order, the Special Conditions of the  Professional Service Order and the further documents  and  enclosures or  annexure or schedules , if any, which are listed in or attached  to the Professional Service Order or  any  other documents connected with the issue of Professional Service Order  , the  accepted  rates  or  the Accepted Priced Bill of Quantities of the Professional Service Order, acceptance and the written specifications, drawings, technical data and other documents  instructions, change orders, directions issued by the Contractor / Employer / Engineer   for the execution and completion of the specified part  or  portion of the scope of the Main Contract and  (ii)  these  General Terms and Conditions of  Professional Service Order. Each  Professional Service Order,  together  with  other documents included therein or attached with Professional Service Order  together with these  general  terms  and  condition  of  Professional Service Order ,  constitutes  a  separate  Professional Service Order  Contract ( hereinafter referred to as ‘Professional Service Order Contract’) that  will  be  effective  upon  issue  of  Professional Service Order  to  the  Subcontractor  with respect to performance of work as described in the Professional Service Order.
                            <br />
                    ...
                    <p><b>3.PRIORITY OF DOCUMENTS :</b>&nbsp;The documents forming the Professional Service Order Contract, listed in the Professional Service Order are to be taken as mutually explanatory of one another unless otherwise provided in the Professional Service Order. For the purposes of interpretation, the priority of the documents shall be in accordance with the following sequence: (i) The Professional Service Order & Employer Professional Service Order terms; (ii) The Special Conditions of Professional Service Order, if any; (iii)The Specifications of Subcontract (shall include Technical Specifications with respect to the Subcontract Works); (iv) The Subcontract Drawings; (v) The Priced Bill of Quantities; (vi) Any other document forming part of the Professional Service Order; (vii) These General Conditions of Professional Service Order. If an ambiguity or discrepancy is found in the documents, the Contractor’s Engineer shall issue any necessary clarification or instruction which shall prevail. </p>
                    <p></p>
                </div>

            </div>
            <div class="footecls" style="margin-top: 210px;">
                <div class="invoiceSignature" style="width: 95%; font-weight: bold;">
            ...
            <div class="instract">
                ...
                <p>
                    <b>4.REPRESENTATIONS AND WARRANTIES :</b>&nbsp; Unless  otherwise  intimated  in  writing  by  the  sub-contractor  to  the  Contractor  during  the  tenure  of  these  General  Terms  and  Condition,  the Subcontractor hereby  , represents, warrants and confirms to the Contractor that :
                                     it is duly organized and validly existing under the Laws of India and has full power and authority to execute and perform its obligations under  the  Professional Service Order Contract   and to carry out the transactions contemplated thereby;
                                     it has taken all necessary corporate and other action under the Applicable Laws and its constitutional documents to authorize the execution, delivery and performance of  the  Professional Service Order Contract;it has the financial standing and capacity to undertakethe    executionof Works  subcontracted to it under the  Professional Service Order Contract constitutes its legal, valid and binding obligation enforceable against it in accordance with the terms hereof; and its obligations under  the  Professional Service Order Contract  shall be legally valid, binding and enforceable obligations against it in accordance with the terms hereof; it is subject to the Laws of India, and hereby expressly and irrevocably waives any immunity in any jurisdiction in respect of  the  Professional Service Order Contract or matters arising there under including any obligation, duty, responsibility or liability hereof;
                                     the execution, delivery and performance of  the  Professional Service Order Contract  will not conflict with, result in the breach of, constitute a default under or accelerate performance required by any of the terms of the constitutional documents of the Subcontractor or any Applicable Laws or any covenant, contract agreement, understanding, decree or order to which it is a party or by which it or any of its properties or assets is bound or affected ; there are no actions, suits, proceedings, or investigations pending or, to the Subcontractor’s knowledge, threatened against it under the Applicable Laws or in equity before any court or before any other judicial, quasi-judicial or other authority, the outcome of which individually or in the aggregate may result in the breach of or constitute a default of the Subcontractor  under  the  Professional Service Order Contract  or which individually or in the aggregate may result in any material impairment of its ability to perform any of its obligations, duties, responsibilities or liabilities under Professional Service Order Contract .
                                    there are no actions, suits, proceedings or investigations pending to the Subcontractor’s knowledge, threatened against it under the Applicable Laws or in equity before any court or before any other judicial, quasi-judicial or other authority, the outcome of which individually or in the aggregate may result in any material adverse effect on its business, properties or assets or its condition, financial or otherwise, or in any material impairment of its ability to perform any of its obligations, duties, responsibilities or liabilities under  the Professional Service Order Contract; it has no knowledge of any violation or default with respect to any order, writ, injunction or decree of any court or any legally binding order of any Government or Government Instrumentalities which may result in any material adverse effect on its ability to perform its obligations, duties, responsibilities or liabilities under to  the  Professional Service Order Contract  and no fact or circumstance exists which may give rise to such proceedings that would adversely affect the performance of its obligations, duties, responsibilities or liabilities under  the  Professional Service Order Contract  ;
                                     it has complied with the Applicable Laws in all material respects and has not been subject to any fines, penalties, injunctive relief or any other civil or criminal liabilities which in the aggregate have or may have a material adverse effect on its ability to perform its obligations, duties, responsibilities or liabilities under  the  Professional Service Order Contract  ; no representation or warranty by the Subcontractor contained herein or in any other document furnished by it to the Contractor or to any Government or Government Instrumentalities in relation to applicable permits, licenses or approvals contains or will contain any untrue statement of material fact or omits or will omit to state a material fact necessary to make such representation or warranty not misleading;
            ...
            <div class="footecls" style="margin-top: 220px;">
                <div class="invoiceSignature" style="width: 95%; font-weight: bold; margin-top: 0px;">
                    <div style="height: 80px">
                        <div style="text-align: right">
            ...
            <div class="instract">
                ...
                <div class="pointinstrctcls">
                    ...
                    <p><b>SUB CONTRACTOR’S SUPERINTENDENCE: </b>Throughout the execution of the Works, and as long thereafter as is necessary to fulfill the Subcontractor’s obligations, the Subcontractor shall provide all necessary Superintendence to plan, arrange, direct, execute, manage, inspect and test the works. Superintendence shall be given by sufficient number of persons having adequate knowledge of the operations to be carried out (including the methods and techniques required, the hazards likely to be encountered and methods of preventing accidents) for the satisfactory and safe execution of the Works</p>
                </div>
            ...
            <div class="instract">
                ...
                <div class="pointinstrctcls">
                    ...
                    <p><b>10.ESCALATION :</b>&nbsp;Unless otherwise specified in the Professional Service Order, the Accepted Subcontract Amount shall be firm till the completion of the Subcontract Works and shall not be subject to escalation of any kind whatsoever.</p>
                    <p><b>11.ESTIMATED QUANTITIES :</b>&nbsp;It shall be clearly understood that Contractor does not accept any responsibility for the correctness or completeness of schedule of items covering the scope of the Professional Service Order and the same is liable to alterations, deductions or additions at the discretion of Contractor / Employer or as set forth elsewhere in the Professional Service Order. The Contractor reserves the right to amend / modify the above scope and delete any item of work from subcontractor’s scope. The quantity mentioned in the bill of quantity is tentative and shall be subjected to variation from time to time. If the quantities vary downward, the rates shall be firm & fixed throughout the execution period for the revised quantity. The quantities shown in the Professional Service Order are estimates only and are not guaranteed and may be increased or decreased by the Contractor and the Subcontractor shall be entitled only to payment for the amount of work actually executed by the Subcontractor / Certified by the Contractor’s Authorized Representative   at the rates accepted in the Professional Service Order and the Subcontractor shall not be entitled to any compensation or other payments in respect of such variation in quantities.</p>
                </div>
            ...
            <div class="instract">
                ...
                <div class="pointinstrctcls">
                    ...
                    <p><b>14.RETENTION :</b>&nbsp;Unless otherwise specified in the  Professional Service Order , an amount equivalent to 5% ( five percent ) of the gross value (including escalation payable, if applicable ) of all invoices, running account bill / interim progress bill shall be deducted from all invoices / running account bill / interim progress bills towards Retention. The retention money so withheld shall be returned without interest to the Subcontractor after completion of Defect Liability Period or O&M Period whichever applicable and Subcontractor’s fulfilling all its obligations, duties, responsibilities and liabilities under the Professional Service Order Contract and signing of ‘No Claim Certificate’ as per the format of the Contractor. In case of failure on the part of the Subcontractor to remedy the defects, the Contractor reserves its right to utilize this retention amount for carrying out the rectification works or discharging obligations, duties, responsibilities or liabilities of the Subcontractor and for this purpose the Contractor shall also have the right to invoke Cross Fall Breach and Set Off provisions of Clause 23. </p>
                    <p><b>15.CLAIMS :</b>&nbsp;Notice for Claims, if any, shall be served by the Subcontractor to Authorized Signatory of the Contractor at its office situated at Bangalore within 14 (Fourteen) days of the occurrence of the event. Claims, if any, shall be substantiated with supporting documents along with the statement which shall state the amount due and payable to the Subcontractor under the Professional Service Order. If the Subcontractor do not submit its claim(s) for whatsoever reason within the stipulated time as above to the Authorized Signatory at its Office, the same shall be deemed to be waived. Notwithstanding any other provision contained herein to the contrary or otherwise, no claims of the Subcontractor shall be admitted (nor deemed to be payable) unless the Employer admits and pays the corresponding claims of the Contractor. Notwithstanding any other provision contained herein to the contrary or otherwise, the Subcontractor shall not be paid any idling charges whatsoever under whatever nomenclature called. </p>
                    <p><b>16.TIME FOR COMPLETION :</b>&nbsp;Time shall be of the Essence of Subcontract Work. The Subcontractor shall commence the execution of the Works within 7 (Seven) days of date of the Professional Service Order and shall proceed with the Works with due expedition and without any delay. The Subcontractor shall complete the whole of the Works fit for the purpose or a Section/Milestone thereof (as the case may be) where Milestone completion dates are stipulated, as stated in the Professional Service Order and shall always include the mobilization period and monsoon period as well as, including achieving the passing of the tests during  execution and  on Completion, and  completing all work which is stated in the Professional Service Order  as being required for the Works or Section/Milestone thereof to be considered to be completed for the purposes of taking-over. In the event of any delay, the Subcontractor shall at all times ensure that  (i)  it uses and continues to use all reasonable endeavors to avoid or reduce the effect of any delay on the completion of the Works or a Section/Milestone thereof (as the case may be) where Milestone completion dates are stipulated in Professional Service Order  and (ii)  subcontractor or vendor appointed by it shall re-Programme or adjust their performance for subcontracted works or services and take measures to avoid or reduce the effect of any delay on the completion of Works or a Section/Milestone thereof (as the case may be) where Milestone completion dates are stipulated in  Professional Service Order. The Subcontractor shall not be entitled to an extension of time in respect of any cause of delay nor for any period of delay.</p>
                </div>

            </div>

            <div class="footecls" style="margin-top: 75px;">
            ...
            <div class="footecls" style="margin-top: 50px;">
                ...
                <div class="invoiceFooter">
                    <img src="../Style/Images/FooterImg.png" alt="PSO Footer" style="height: 70px; width: 97%" />
                </div>
            ...
            <div class="instract">
                ...
                <div class="pointinstrctcls">
                    <p><b>32.NOTICES, APPROVALS, CERTIFICATES, CONSENTS, DETERMINATIONS, REQUESTS AND DISCHARGES AND OTHER COMMUNICATION :</b>&nbsp;Wherever these General terms and Conditions provide for the giving or issuing of any notices, approvals, certificates, consents, determinations, requests and discharges, unless otherwise specified; such notices, approvals, certificates, consents, determinations, requests and discharges shall be in writing and the words ‘notify’, ‘approve’, ‘certify’, ‘confirm’ ‘determine’, ‘request’ or ‘discharge’ shall be construed accordingly. All communication from the Contractor to the Subcontractor shall be delivered by hand (against receipt), or sent by Registered A. D. Post or by courier service or through official electronic mail to the Authorized Officer of the Subcontractor as notified by the Subcontractor  from time to time. All communication from the Subcontractor to the Contractor shall be delivered by hand (against receipt), or sent by Registered A. D. Post or by courier service or through official electronic mail.  Day to day communication shall be addressed to the Authorized Representative of the Contractor at the Project Site. Contractual correspondence or notice for claim which may involve financial implications either now or at a later date shall be addressed to the Authorized Signatory of the Contractor at its Office situated at United Global Corporation Ltd., No.399, 1st Floor, 24th Cross, Banashankari 2nd Stage, Bangalore,India – 560070.  Further it is expressly agreed that no notice as regards claims, if any, from the Subcontractor which may involve financial implications either now or at a later date shall be treated as valid unless the same is served within 14 (Fourteen) days of occurrence of the event and served to the Authorized Signatory of the Contractor at its  Office situated at  Bangalore </p>
                    <p>And that any notice not served within the above specified time limit or not served to the Authorized Signatory of the Contractor at its Office situated  at Bangalore shall be treated as invalid.     </p>
                    <p><b>33.APPLICABLE LANGUAGE :</b>&nbsp;The ruling language of the Professional Service Order including all documents thereof and for all further correspondence between the Contractor and the Subcontractor shall be English.     </p>
                    <p><b>34.GOVERNING LAWS :</b>&nbsp;The Professional Service Order shall be governed by the Laws of India and courts in Bangalore shall have exclusive jurisdiction over all matters arising out of or relating to the Professional Service Order Contract. Notwithstanding the place where the Professional Service Order is signed or the place where the work under the Professional Service Order is to be executed, it is mutually understood and agreed by and between the Parties hereto, that the Professional Service Order Contract shall be deemed to have been entered into by the Parties concerned in the City of Bangalore.</p>
                    <p><b>35.PRINCIPAL TO PRINCIPAL :</b>&nbsp;It is agreed and understood that, as between the Contractor / Employer and the Subcontractor, the legal relationship is strictly on a principal-to-principal basis. Nothing is deemed to constitute or imply any other legal relationship such as principal- agent, master-servant or otherwise. It is expressly agreed that there shall be no principal- agent, master-servant or any other relationship between the Contractor and the Subcontractor under these General Terms and Conditions and Professional Service Order and no representation to any such effect would be made by the Subcontractor to anyone.  The Subcontractor shall indemnify the Contractor / Employer against any claims, expenses, liabilities and losses and for any third-party claims regarding and/or arising under or in connection with the relationship and/or misrepresentation thereby by the Subcontractor.    </p>
                    <p><b>36.CONFIDENTIAL DETAILS :</b>&nbsp;All matters related to the Professional Service Order Contract, the Works and all other documents shall be regarded by the Subcontractor as being highly confidential and shall not be disclosed to any party, person or entity. The Subcontractor shall at no time hereinafter use any technical information or intellectual property, in relation to the Professional Service Order Contract and the Main Contract. The Subcontractor shall not have the right to advertise or otherwise permit the dissemination of publicity concerning the Professional Service Order Contract.This Confidentiality obligation shall survive expiry or termination of the Professional Service Order.    </p>
                    <p><b>37.DISPUTERE SOLUTION AMICABLE SETTLEMENT AND ARBITRATION :</b>&nbsp;In case of any difference or dispute, both Parties shall attempt to settle the difference or dispute amicably before the commencement of Arbitration. Except where otherwise provided for in  the  Professional Service Order Contract   , all questions and disputes relating to the meaning of the specifications, designs, drawings and instructions herein before mentioned and as to the quality of workmanship or materials used on the work or as to any other question, claim, right, matter or thing whatsoever in any way arising out of or relating to the Professional Service Order Contract  , designs drawings, specifications, estimates, instructions, orders or these conditions of otherwise concerning the works, or the execution or failure to execute the same whether arising during the progress of the work or after the completion or abandonment thereof; after written notice by either Party to the Contract, shall be referred to a  person  appointed  by  the  Employer  to  act  as arbitrator in accordance with the terms of the Contract. It is also a term of the Professional Service Order Contract that no person other than a person appointed by Contractor as aforesaid should act as arbitrator and if for any reason, that is not possible, the matter is not be referred to arbitration at all. It is a term of the Professional Service Order Contract that the Party invoking arbitration shall specify the dispute or disputes to be referred to arbitration under this Clause together with the amount or amounts claimed in respect of each such dispute. The arbitrator may from time to time with consent of the Parties enlarge the time, for making and publishing the award. The work under the Professional Service Order shall, if reasonably possible, continue during the arbitration proceedings. The venue of arbitration shall be Bangalore. The award of the arbitrator shall be final, conclusive and binding on all Parties to these General terms and Conditions. The cost of arbitration shall be borne by the parties to the dispute, as may be decided by the arbitrator. Subject as aforesaid, the provisions of the Arbitration and Conciliation Act, 1996, or any statutory modification or re-enactment thereof and the rules made there under and for the time being in force shall apply to the arbitration proceeding under this Clause.     </p>
                    <p><b>38.ACCEPTANCE OF W.O. :</b>&nbsp;The W.O and the terms herein shall be deemed to be accepted by the Sub-Contractor upon the receipt of the W.O. or advance payment to his account unless expressly rejected by Sub-Contractor in writing or Sub-Contractor has returned the advance received for the work.    </p>

                </div>

            </div>

            <div class="footecls" style="margin-top: 110px;">
                <div class="invoiceSignature" style="width: 95%; font-weight: bold; margin-top: 0px;">
                    <div style="height: 80px">
                        <div style="text-align: right">
            ...
            <div class="instract">
                ...
                <div class="pointinstrctcls">
                    <p><b>40. PARTIES HERETO AGREES THAT UNLESS OTHERWISE SPECIFICALLY MENTIONED IN THE Professional Service Order:</b></p>
                    <p>(i)	These general terms and conditions shall form part of any resulting Professional Service Order placed by Contractor on Subcontractor.  </p>
                    <p>(ii)	All the Professional Service Order  issued  by  Contractor  to  sub-contractor  during  the  period of the work  from  the  date  of  acceptance  of  these  General  Terms and  Conditions  of  Professional Service Order  shall  be  strictly  governed  by  the  terms  and  conditions  of  these  General Terms and Conditions. </p>
                    <p>(iii)	No term or condition stated in any subcontractor solicitation shall become part of Professional Service Order or shall otherwise be binding on Contractor.</p>
            ...
            <div class="footecls" style="margin-top: 800px;">
            ...
            <div class="footecls" style="margin-top: 0px;">
                <div class="invoiceSignature" style="width: 95%; font-weight: bold; margin-top: 125px; display: none">
                    <div style="height: 80px">
                        <div style="text-align: right">
                ...
                <tr>
                    ...
                    <td>
                        <%-- <div class="invoiceSignature" style="width: 95%; font-weight: bold;margin-top:52px;">
                            <div style="height: 80px">
                                <div style="text-align: right">
                                     <asp:ImageButton ID="ImageButton1" Width="150px" Height="80px" runat="server" />
            ...
            <div class="invoiceSignature" style="width: 100%; font-weight: bold; margin-top: 195px;">
            ...
            <div class="invoiceFooter">
                <img src="../Style/Images/FooterImg.png" alt="PSO Footer" style="height: 80px; width: 98%" />
            </div>
    ...
    associated contractors at UGCL or UGCL’s Customer location executed wide Professional Service Order Number<span>
        <asp:Label runat="server" Text="" ID="lblPSONo3"></asp:Label></span>  dated <span>
            <asp:Label runat="server" Text="" ID="lblPSODate2"></asp:Label></span> is been
    ...
    employees is attached herewith.
            ...
            <div class="invoiceFooter">
                <img src="../Style/Images/FooterImg.png" alt="PSO Footer" style="height: 80px; width: 100%" />
            </div>
    ...
    <div id="divToPrint6" runat="server">
        ...
        <div id="divTableDataHolder6" style="width: 880px">
            ...
            <div style="width: 100%;">
                <img src="../Style/Images/HeaderImg.png" alt="PSO Header" style="width: 98%; height: 110px; padding-top: 30px;" />
            </div>
            <div style="text-align: right; padding-right: 30px">
                <b>Page No:
                        ...
                        <tr>
                            <td style="padding: 0;">
                                <asp:GridView ID="GridPrint3" AllowPaging="true" PageSize="9000" runat="server" Width="853.59px" AutoGenerateColumns="false" CssClass="GridCenter" FolderStyle="../Gridstyles/grand_gray">
                                    <Columns>
                                        <ogrid:Column DataField="Scope_Of_Work" HeaderText="Description of Work" ItemStyle-Width="590px" Align="Center" HeaderAlign="Right"></ogrid:Column>
                                        <ogrid:Column DataField="No_of_Staff_to_be_Deputed" HeaderText="No. of Staff to be Deputed" ItemStyle-HorizontalAlign="Right" ItemStyle-Width="600px" Wrap="true"></ogrid:Column>
                                        <ogrid:Column DataField="Tentavie_Time" HeaderText="Tentavie Time Required" ItemStyle-Width="600px" Align="Center" ItemStyle-HorizontalAlign="Center" Wrap="true"></ogrid:Column>
                                        <ogrid:Column DataField="Amount" HeaderText="Amount" ItemStyle-Width="600px" Align="Right" ItemStyle-HorizontalAlign="Right"></ogrid:Column>
            ...
            <div class="invoiceFooter">
                <img src="../Style/Images/FooterImg.png" alt="PSO Footer" style="height: 80px; width: 90%" />
            </div>
                        ...
                        <tr>
                            <td style="padding: 0;">
                                <asp:GridView ID="GridPrint4" runat="server" Width="853.59px" AutoGenerateColumns="false" CssClass="GridCenter" FolderStyle="../Gridstyles/grand_gray">
                                    <Columns>
                                        <ogrid:Column DataField="Scope_Of_Work" HeaderText="Description of Work" ItemStyle-Width="590px" Wrap="true" Align="ce"></ogrid:Column>
                                        <ogrid:Column DataField="Quantity" HeaderText="Tentavie Time Required" ItemStyle-Width="600px" Wrap="true"></ogrid:Column>
                                        <ogrid:Column DataField="Rate" HeaderText="Amount" ItemStyle-Width="600px"></ogrid:Column>
                                        <ogrid:Column DataField="UOM_Name" HeaderText="No. of Staff to be Deputed" ItemStyle-Width="600px" Wrap="true"></ogrid:Column>
    ...
    <div id="divToPrint27" runat="server">
        <div id="divTableDataHolder27" style="width: 880px">
            ...
            <div style="text-align: right; padding-right: 30px">
                ...
                <b>Page No:
                    <asp:Label runat="server" ID="lblPageNo43"></asp:Label></b>
            </div>
            <div class="mypageadjustthree">
                <br />
                <b>SCOPE OF WORK</b>
