...
public partial class PaymentIndent_PSO_Print : System.Web.UI.Page
{
    ...
    private void GetPSODetails(string PSONo)
    {
        objPaymentIndentBL = new PaymentIndentBL();
        ds = new DataSet();
        objPaymentIndentBL.Task = "GetPSODetailsPrint";
        objPaymentIndentBL.StateCode = Request.QueryString["State"].ToString();
        objPaymentIndentBL.POWO_Number = PSONo;
        objPaymentIndentBL.load(con, PaymentIndentBL.eLoadSp.POWO_PRINT, ref ds);
    ...
    private void BindPSOItems()
    {
        try
        {
            objPaymentIndentBL = new PaymentIndentBL();
            ds = new DataSet();
            objPaymentIndentBL.Task = "GetPSOItemDetailsPrint";
            objPaymentIndentBL.StateCode = Request.QueryString["State"].ToString();
    ...
    private void BindSOWItems()
    {
        try
        {
            ...
            objPaymentIndentBL = new PaymentIndentBL();
            ds = new DataSet();
            objPaymentIndentBL.Task = "GetSOWItemsPSOPrint";
            objPaymentIndentBL.StateCode = Request.QueryString["State"].ToString();
            objPaymentIndentBL.POWO_ID = Convert.ToInt32(ViewState["WOID"]); ;
            objPaymentIndentBL.load(con, PaymentIndentBL.eLoadSp.POWO_PRINT, ref ds);
    ...
    private void AssignPageNumber()
    {
        try
        {
            ...
            {
                lblPageNo1.Text = "1 of 20";
                lblPageNo3.Text = "2 of 20";
                lblPageNo4.Text = "3 of 20";
                lblPageNo5.Text = "4 of 20";
                lblPageNo6.Text = "5 of 20";
                lblPageNo7.Text = "6 of 20";
                lblPageNo8.Text = "7 of 20";
                lblPageNo9.Text = "8 of 20";
                lblPageNo10.Text = "9 of 20";
                lblPageNo11.Text = "10 of 20";
                lblPageNo12.Text = "11 of 20";
                lblPageNo13.Text = "12 of 20";
                lblPageNo14.Text = "13 of 20";
                lblPageNo15.Text = "14 of 20";
                lblPageNo16.Text = "15 of 20";
                lblPageNo17.Text = "16 of 20";
                lblPageNo18.Text = "17 of 20";
                //lblPageNo19.Text = "18 of 20";
                //lblPageNo20.Text = "19 of 20";
                lblPageNo21.Text = "20 of 20";
            }
            ...
            else if (PSO_ItemCount < 6 && SOW_ItemCount >= 20)
            {
                ...
                lblPageNo18.Text = "17 of 21";
                //lblPageNo19.Text = "18 of 21";
                //lblPageNo20.Text = "19 of 21";
                lblPageNo21.Text = "20 of 21";
                lblPageNo22.Text = "21 of 21";
            }
            else if (PSO_ItemCount >= 6 && SOW_ItemCount >= 20)
            {
                if (SOW_ItemCount >= 18)
                ...
                {
                    lblPageNo1.Text = "1 of 42";
                    lblPageNo2.Text = "2 of 42";
                    lblPageNo3.Text = "3 of 42";
                    lblPageNo4.Text = "4 of 42";
                    lblPageNo5.Text = "5 of 42";
                    lblPageNo6.Text = "6 of 42";
                    lblPageNo7.Text = "7 of 42";
                    lblPageNo8.Text = "8 of 42";
                    lblPageNo9.Text = "9 of 42";
                    lblPageNo10.Text = "10 of 42";
                    lblPageNo11.Text = "11 of 42";
                    lblPageNo12.Text = "12 of 42";
                    lblPageNo13.Text = "13 of 42";
                    lblPageNo14.Text = "14 of 42";
                    lblPageNo15.Text = "15 of 42";
                    lblPageNo16.Text = "16 of 42";
                    lblPageNo17.Text = "17 of 42";
                    lblPageNo18.Text = "18 of 42";
                    //lblPageNo19.Text = "19 of 42";
                    //lblPageNo20.Text = "20 of 42";
                    lblPageNo21.Text = "21 of 42";
                    lblPageNo22.Text = "22 of 42";
                    lblPageNo23.Text = "23 of 42";
                    lblPageNo24.Text = "24 of 42";
                    lblPageNo25.Text = "25 of 42";
                    lblPageNo26.Text = "26 of 42";
                    lblPageNo27.Text = "27 of 42";
                    lblPageNo28.Text = "28 of 42";
                    lblPageNo29.Text = "29 of 42";
                    lblPageNo30.Text = "30 of 42";
                    lblPageNo31.Text = "31 of 42";
                    lblPageNo32.Text = "32 of 42";
                    lblPageNo33.Text = "33 of 42";
                    lblPageNo34.Text = "34 of 42";
                    lblPageNo35.Text = "35 of 42";
                    lblPageNo36.Text = "36 of 42";
                    lblPageNo37.Text = "37 of 42";
                    lblPageNo38.Text = "38 of 42";
                    lblPageNo39.Text = "39 of 42";
                    lblPageNo40.Text = "40 of 42";
                    //lblPageNo41.Text = "41 of 42";
                }
            }
