<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/SNC.Master" AutoEventWireup="true" CodeBehind="~/Procurement/ProffessionalServiceOrderList.aspx.cs" Inherits="Proffessional_Service_Order" %>
    ...
    <div class="panel panel-default">
        <div class="panel-heading">
            <h3 class="panel-title">
                ...
                Proffessional Service Order List
            </h3>
        </div>
        <div class="panel-body">
            <center>
                <ogrid:Grid runat="server" ID="Grid_PSO" CallbackMode="false" AutoGenerateColumns="false" 
                    OnRowDataBound="Grid_PSO_RowDataBound" 
                    ...
                    <ExportingSettings ExportAllPages="true" ExportTemplates="true" ExportedFilesTargetWindow="New"
                         ColumnsToExport="PSONo,PSODate,Subcon_name,Type_Name,DurationOfWork,Status,Name,Prepared_By,Other_Terms,Remarks" />
                    ...
                    <Columns>
                        <ogrid:Column DataField="PSONo" HeaderText="PSO No" Width="190px" >
                             <TemplateSettings  TemplateId="PSONoTemplate"/>
                        </ogrid:Column>
                        <ogrid:Column DataField="PSODate" HeaderText="Date" Width="120px" ></ogrid:Column>
                        ...
                        <ogrid:Column DataField="Type_Name" HeaderText="PSO Type" Wrap="true"   Width="150px"></ogrid:Column>
                        <ogrid:Column DataField="DurationOfWork" HeaderText="Duration Of Work" Align="center" Width="150px"></ogrid:Column>                 
                        <ogrid:Column DataField="Status" HeaderText="PSO Status" Width="100px" ></ogrid:Column>
                        ...
                        <ogrid:Column DataField="Other_Terms" HeaderText="Other Terms"  Wrap="true" Width="350px"></ogrid:Column>
                        <ogrid:Column DataField="Remarks" HeaderText="Remarks" Wrap="true" ></ogrid:Column>          
                        <ogrid:Column DataField="" HeaderText="Delete" > <TemplateSettings  TemplateId="GT_PSo_Delete"/>
                        </ogrid:Column>
                    </Columns>
                    <Templates>
                        <ogrid:GridTemplate ID="PSONoTemplate" runat="server"><Template>
                        <asp:HyperLink ID="lnkPSONo" runat="server" CssClass="gridPSO"  Text='<%#Container.DataItem["PSONo"] %>'>
                        </asp:HyperLink>
                        </Template></ogrid:GridTemplate>
                         <ogrid:GridTemplate ID="GT_PSo_Delete" runat="server">
                            <Template>
                               <asp:LinkButton ID="lnkPSO_Delete" runat="server" CssClass="gridCB" OnClientClick="beforedelete();" CommandArgument='<%# Container.PageRecordIndex %>'  OnCommand="lnkPSO_Delete_Click" Text="Delete">
                        </asp:LinkButton>
                            </Template>
                        </ogrid:GridTemplate>
                ...
                <br />
                <center>
                    <a href="ProffessionalServiceOrder.aspx" runat="server" id="lnkbtnAdd" class="btn btn-default">Add New PSO</a>               
            ...
            <CssSettings CSSExportHeaderCellStyle="font-weight: bold;font-size:16px; font-name:Trebuchet; text-decoration: underline;color: white; border-style:solid; border-width:medium; background-color:gray;"  CSSExportCellStyle="font-weight: normal;font-size:14px; font-name:Trebuchet; font-style: regular;color: black; border-style:solid; border-width:thin; border-color:black; background-color:White;"/>    
			 <ExportingSettings ExportAllPages="true" ExportTemplates="true" 
                  ColumnsToExport="Indent_No,PSONo,PSODate,Category_Name,Item_Name,UOM,Total_Qty_Involved,Qty_required,Price,Amount,Amt_With_Tax,Referred_VendorCount,BOQ,BOQ_No,Tentative_Date,Whether_Req_Qty"  />
            <Columns>
              
                  <ogrid:Column DataField="Indent_No" HeaderText="Indent No" Width="100"></ogrid:Column>
                    <ogrid:Column DataField="PSONo" HeaderText="PSO No" Width="150"></ogrid:Column>
                <ogrid:Column DataField="PSODate" HeaderText="Date"  Width="100"></ogrid:Column>
           ...
           <ogrid:GridTemplate ID="BOQTemplatePSO" runat="server">
            <Template>
             ...
             <ogrid:GridTemplate ID="WhetherReqQtyTemplatePSO" runat="server">
                 <Template>
