    ...
    public partial class PurchaseOrderList : System.Web.UI.Page
    {
        ...
        protected void Grid_PO_RowDataBound(object sender, Obout.Grid.GridRowEventArgs e)
        {
            try
            {
                if (e.Row.RowType == Obout.Grid.GridRowType.DataRow)
                {
                    ...
                    Editlik.NavigateUrl = "~/Procurement/PurchaseOrder.aspx?PONo=" + Editlik.Text;
                    if (Accessds != null && Accessds.Tables.Count > 0 && Accessds.Tables[0].Rows.Count > 0)
                    {
                        if (Accessds.Tables[0].Rows[0]["Role"].ToString() != "Application Admin")
                        {
                    ...
                    //{
                        LinkButton lnkPO_Delete = e.Row.Cells[16].FindControl("lnkPO_Delete") as LinkButton;
        ...
        protected void Grid_PO_DeleteCommand(object sender, Obout.Grid.GridRecordEventArgs e)
        {
            try
            {
                ...
                {
                    BindPurchaseOrderList();
                    ScriptManager.RegisterStartupScript(this, GetType(), "CustomAlert", "Alert.render('PO has been deleted successfully');", true);
                }
                else
                {
                    ScriptManager.RegisterStartupScript(this, GetType(), "CustomAlert1", "Alert1.render('PO is refered other process!');", true);
                }
            }
            catch (Exception ex)
            {
