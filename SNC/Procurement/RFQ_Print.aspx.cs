...
{
    public partial class RFQ_Print : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                if (Session["UID"] != null)
                {
                    ...
                    {
                        GetCompanyDetails();
                        GetPurchaseOrderDetails(Request.QueryString["RFQNo"].ToString());
                        BindPOItems();
                        BindTaxGrid();
        ...
        private void GetPurchaseOrderDetails(string RFQNo)
        {
            ...
            if (ds.Tables[0].Rows.Count > 0)
            {
                ...
                lblPONo1.Text = ds.Tables[0].Rows[0]["RFQNo"].ToString();
                lblPONo2.Text = ds.Tables[0].Rows[0]["RFQNo"].ToString();
                lblPONo3.Text = ds.Tables[0].Rows[0]["RFQNo"].ToString();
                lblPONo4.Text = ds.Tables[0].Rows[0]["RFQNo"].ToString();
                lblPONo5.Text = ds.Tables[0].Rows[0]["RFQNo"].ToString();
                ...
                lbldate.Text = ds.Tables[0].Rows[0]["RFQDate"].ToString();
        ...
        { 
            try
            {
                objRFQ = new RequestForquotationBL();
                ds = new DataSet();
                //objRFQ.PO_ID=Convert.ToInt32(Request.QueryString["RFQNo"].ToString());
                objRFQ.RFQ_ID = Convert.ToInt32(ViewState["RFQID"]);
                objRFQ.load(con, RequestForquotationBL.eLoadSp.SELECT_RFQ_ITEMS_BY_RFQNO_FOR_PRINT, ref ds);
                ...
                {
                    lblPageNo1a.Text = "1 of 3";
                    lblPageNo1b.Text = "2 of 3";
                    lblPageNo2.Text = "3 of 3";
                    //lblPageNo3a.Text = "4 of 7";
                    //lblPageNo3b.Text = "5 of 7";
                    //lblPageNo3c.Text = "6 of 7";
                    //lblPageNo3d.Text = "7 of 7";
                    div_Continue1b.Visible = true;
                    divToPrint1b.Visible = true;
                    divToPrint1c.Visible = false;
                    divToPrint1d.Visible = false;
                    divToPrint1e.Visible = false;
            ...
            {
                //.logError(ErrorLogger.enumErrorTypes.DBSelectError, ex, this.Page.ToString(), System.Reflection.MethodBase.GetCurrentMethod().Name, Session["UID"] != null ? Session["UID"].ToString() : string.Empty);
            }
        }
        ...
        private void BindTaxGrid()
        {
            try
            {
                objRFQ = new RequestForquotationBL();
                ds = new DataSet();
                objRFQ.RFQ_ID = Convert.ToInt32(ViewState["RFQID"].ToString());
                objRFQ.load(con, RequestForquotationBL.eLoadSp.SELECT_RFQ_TAX_BY_RFQID_FOR_PRINT, ref ds);
                if (ds.Tables[0].Rows.Count > 0)
                {
        ...
        private void BindPOItemWiseTaxGrid()
        {
            try
            {
                ...
                ds = new DataSet();
                objRFQ.RFQ_ID = Convert.ToInt32(ViewState["RFQID"].ToString());
                objRFQ.load(con, RequestForquotationBL.eLoadSp.SELECT_RFQ_ITEMWISE_TAX_BY_RFQ_ID_FOR_PRINT, ref ds);
                if (ds.Tables[0].Rows.Count > 0)
                {
