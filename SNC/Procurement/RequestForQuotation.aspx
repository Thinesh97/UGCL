<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/SNC.Master" AutoEventWireup="true" CodeBehind="RequestForQuotation.aspx.cs" Inherits="SNC.Procurement.RequestForQuotation" %>
    ...
    <ajaxToolkit:ToolkitScriptManager ID="ToolkitScriptManager1" runat="server"></ajaxToolkit:ToolkitScriptManager>
     <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <div class="row">
                <div class="col-md-2">RFQ No</div>
                <div class="col-md-4">
                    <asp:TextBox runat="server" ID="txtRFQNo" Enabled="false" CssClass="form-control" MaxLength="50"></asp:TextBox>
                </div>
            ...
            <div class="row">
                <div class="col-md-2">
                    Date&nbsp;
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtRFQDate" CssClass="Validation_Text" ValidationGroup="ValPO" ErrorMessage="*"></asp:RequiredFieldValidator>
                </div>
                <div class="col-md-4">
                    <asp:TextBox ID="txtRFQDate" CssClass="form-control" autocomplete= "off" onkeypress="javascript:return false;" onpaste="javascript:return false;" runat="server" TabIndex="3"></asp:TextBox>
                    <ajaxToolkit:CalendarExtender runat="server" ID="cal1" Format="dd-MM-yyyy" TargetControlID="txtRFQDate"></ajaxToolkit:CalendarExtender>
                </div>
                <div class="col-md-2">
                    Project Name&nbsp;
                ...
                <div class="col-md-4">
                    <asp:DropDownList runat="server" ID="ddlProject"  class="chosen-select form-control" AutoPostBack="true" OnSelectedIndexChanged="ddlProject_SelectedIndexChanged" TabIndex="4"></asp:DropDownList>
                </div>
            </div>
            ...
            <br />
                ...
                <asp:TextBox ID="txtTotal" Text="0" runat="server" Visible="false" Style="display: block"></asp:TextBox>
             <div class="panel-heading">
            <h3 class="panel-title" style="text-align:center">
                <i class="glyphicon glyphicon-envelope"></i>

                 Request For Quotation Item List
               ...
               <div class="panel-body">
                ...
                <ogrid:Grid runat="server" ID="Grid_DirectRFQItem" ShowColumnsFooter="true" OnDeleteCommand="Grid_DirectRFQItem_DeleteCommand" 
                    ...
                    CallbackMode="false" FolderStyle="../Gridstyles/grand_gray" AllowAddingRecords="false" AllowFiltering="true" AllowPaging="true" PageSize="10">
                    ...
                    <Templates>
                        <ogrid:GridTemplate ID="ItemTemplate" runat="server">
                            <Template>
                               <asp:LinkButton ID="lnkRFQItem" Text='<%#Container.DataItem["Item_Name"] %>' CommandArgument='<%#Container.DataItem["Item_Type"] %>' CommandName='<%#Container.DataItem["RFQ_Item_Id"] %>'  OnClick="lnkWOItem_Click" runat="server" CssClass="gridCB">
                                        </asp:LinkButton>
                            </Template>
                        </ogrid:GridTemplate>
                    </Templates>
                ...
                <br />
                <br />
             <h4 style="text-align:center">  Request For Quotation Tax List </h4>
             <div class="panel-body">
                     <center>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <asp:TextBox runat="server" ID="txtAmount"  onpaste="javascript: return false" autocomplete="off" Text="0.00" CssClass="form-control input-pos-float"></asp:TextBox>
                        </div>
                    </div>
