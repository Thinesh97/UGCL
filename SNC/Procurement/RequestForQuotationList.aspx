<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/SNC.Master" AutoEventWireup="true" CodeBehind="RequestForQuotationList.aspx.cs" Inherits="SNC.Procurement.RequestForQuotationList" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <script type="text/javascript">
        ...
        function exportgridPending() {
            Grid_RFQ_Pending.exportToExcel();
        }
     ...
     <div class="panel panel-default">
        ...
        <div class="panel-body">
             <h4 style="text-align:center"> Pending Request For Quotation </h4>
             <center>
        <ogrid:Grid runat="server" ID="Grid_RFQ_Pending" CallbackMode="false" AutoGenerateColumns="false" 
            OnRowDataBound="Grid_RFQ_RowDataBound_Pending" 
            ...
            <ExportingSettings ExportAllPages="true" ExportTemplates="true" ExportedFilesTargetWindow="New"
                 ColumnsToExport="RFQNo,RFQDate,IndentNo,Vendor_name,VendorRef,DeliverySchedule,Name,Prepared_By,NetTotalAmt,UGCLRef,Status,Other_Terms,Remarks,ApprovalStatus,Approver_Com" />
            ...
            <Columns>
                <ogrid:Column DataField="RFQNo" HeaderText="RFQ No" Width="200px" >
                     <TemplateSettings  TemplateId="GridRFQ_Pending"/>
                </ogrid:Column>
                <ogrid:Column DataField="RFQDate" HeaderText="Date" Width="120px" ></ogrid:Column>
                ...
                <ogrid:Column DataField="ApprovedBy" HeaderText="Approved By" Wrap="true" Width="120"></ogrid:Column>
                ...
                <ogrid:Column DataField="" HeaderText="Delete" >
                     <TemplateSettings  TemplateId="GT_RFQ_Delete"/>
                </ogrid:Column>
            </Columns>
            <Templates>
                <ogrid:GridTemplate ID="GridRFQ_Pending" runat="server">
                    <Template>
                       <asp:HyperLink ID="lnkRFQNo" runat="server" CssClass="gridCB"  Text='<%#Container.DataItem["RFQNo"] %>'>
                </asp:HyperLink>
                    </Template>
                </ogrid:GridTemplate>
                 <ogrid:GridTemplate ID="GT_RFQ_Delete" runat="server">
                    <Template>
                       <asp:LinkButton ID="lnkRFQ_Delete" runat="server" CssClass="gridCB" OnClientClick="beforedelete();" CommandArgument='<%# Container.PageRecordIndex %>'  OnCommand="lnkRFQ_Delete_Click" Text="Delete">
                </asp:LinkButton>
                    </Template>
                </ogrid:GridTemplate>
        ...
        <br />
                <center>
                    <a href="RequestForQuotation.aspx" runat="server" id="A1" class="btn btn-default">Add New RFQ</a>               
                    <asp:Button ID="Button1" runat="server" Text="Export To PDF" OnClick="btnExportToPDF_Click" CssClass="btn btn-default"></asp:Button>
                    <input onclick="exportgridPending()" type="button" class="btn btn-default" name="Export To Excel" value=" Export To Excel" />  
                    <asp:Button ID="Button2"  runat="server" Text="Generate RFQ Items List"  OnClick="btn_GenPOItemsList_Click" CssClass="btn btn-default"/>   
                </center>
            </center>

            <br />
            <h4 style="text-align:center"><%-- Approved Direct Purchase Orders --%></h4>
            <center>
        <ogrid:Grid runat="server"  ID="Grid_PO" CallbackMode="false" AutoGenerateColumns="false"
            ...
            <Columns>
                <ogrid:Column DataField="PONo" HeaderText="PO No" Width="200px" >
        ...
        <br />
                <center>
                    <a href="DirectPurchaseOrder.aspx" runat="server" id="lnkbtnAdd" class="btn btn-default" visible="false">Add New Direct PO</a>               
                    <asp:Button ID="btnExportToPDF" runat="server" Text="Export To PDF" OnClick="btnExportToPDF_Click" Visible="false" CssClass="btn btn-default"></asp:Button>
                    <input onclick="exportgrid()" style="display:none" type="button" class="btn btn-default" name="Export To Excel" value=" Export To Excel" />  
                    <asp:Button ID="btn_GenPOItemsList" Visible="false"  runat="server" Text="Generate PO Items List"  OnClick="btn_GenPOItemsList_Click" CssClass="btn btn-default"/>   
                </center>
            </center>
