<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/SNC_Print.Master" AutoEventWireup="true" CodeBehind="WO_Print_PDF.aspx.cs" Inherits="WO_Print_PDF" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="divToPrint1" runat="server">
        ...
        <div id="divTableDataHolder1" style="width: 880px">
            ...
            <div style="width: 100%;">
                <img src="../Style/Images/HeaderImg.png" alt="WO Header" style="width:100%; height:120px"/>
            </div>
            ...
            <table class="table table-bordered" style="width: 97%; margin-bottom:0px;" id="mytbl1">
                ...
                <tr>
                    ...
                    <td rowspan="3" style="border-bottom:hidden">
                    ...
                    <td style="padding:0;">
                        <asp:GridView ID="GridPrint1" Width="100%" runat="server" OnRowDataBound="GridPrint_RowDataBound"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Description of Services" ItemStyle-Width="60%">
                                    <ItemTemplate>
            ...
            <table runat="server" class="table table-bordered" style="width: 97%; padding: 0;margin-top: -1px;" id="mytbl3a">
                ...
                <tr runat="server" id="tr_IGST" style="display:none">
                    <td style="text-align:right; font-weight:bold; width:65%">
                ...
                <tr runat="server" id="tr_CGST" style="display:none">
                    <td style="text-align:right; font-weight:bold; width:65%">
                ...
                <tr runat="server" id="tr_SGST" style="display:none">
                ...
                <tr style="display:none">
                    <td style="text-align:right;width:60%; font-weight:bold" ><p>Total</p></td>
                ...
                <tr>
                    <td style="border-bottom:1px solid #fff;border-right:1px solid #fff;">
                        ...
                        1. Annexure A,B & C Are Integral Part of This Work Order
                        </p>
                    </td>
            ...
            <div runat="server" id="div_Continue" style="width:97%; height:30px;">
        ...
        <div id="divTableDataHolder2" style="width: 880px">
            ...
            <div style="width: 100%;">
             ...
             <div style="text-align: right; padding-right: 30px">
              ...
              <div class="mypageadjust">
            <b>WORK ORDER - <asp:label runat="server" ID="lblWONo2"></asp:label></b>
            ...
            <table class="table table-bordered" style="width: 97%; margin-bottom:0px;" id="mytbl2b">
                ...
                <tr runat="server" visible="false">
                    <td>
                        <asp:GridView ID="GridView2" Width="100%" runat="server" CssClass="GridCenter" AutoGenerateColumns="false" FolderStyle="../Gridstyles/grand_gray">
            ...
            <table class="table table-bordered" style="width: 97%; padding: 0;margin-top: -1px;" id="mytbl3b">
                ...
                <tr style="display:none">
                    <td style="text-align:right" colspan="7"><asp:Label runat="server" Text="Label" ID="Label16"></asp:Label></td>
                </tr>
                <tr runat="server" id="tr1" style="display:none">
                    <td style="text-align:right; font-weight:bold; width:65%">
                        IGST INPUT @<asp:Label runat="server" ID="Label17"></asp:Label>%
                    </td>
                    <td style="text-align:right; width:100px">
                ...
                <tr runat="server" id="tr2" style="display:none">
                    <td style="text-align:right; font-weight:bold; width:65%">
                        CGST INPUT @<asp:Label runat="server" ID="Label20"></asp:Label>%
                    </td>
                    <td style="text-align:right; width:100px">
                ...
                <tr runat="server" id="tr3" style="display:none">
                    <td style="text-align:right; font-weight:bold">
                        SGST INPUT @<asp:Label runat="server" ID="Label23"></asp:Label>%
                    </td>
                    <td style="text-align:right; width:100px">
                ...
                <tr style="display:none">
                    <td colspan="3" style="padding:0;">
                        <asp:GridView ID="GridView3" Width="100%" ShowHeader="false" CssClass="GridCenter" runat="server" AutoGenerateColumns="false" FolderStyle="../Gridstyles/grand_gray">
                ...
                <tr style="display:none">
                    <td style="text-align:right;width:60%; font-weight:bold" ><p>Total</p></td>
                    <td colspan="3" style="text-align:right"><asp:Label runat="server" Text="" ID="Label26"></asp:Label></td>
                </tr>
                
                <tr style="display:none">
                    <td colspan="4">
                        Amount Chargeable (in words) : &nbsp;
                        <b>INR <asp:Label runat="server" Text="" ID="Label27"></asp:Label></b>
                    </td>
                </tr>
            ...
            <div class="invoiceFooter" style="margin-top:40px;">
                <p style="margin:0;">This is a Computer Generated Document</p>
                <img src="../Style/Images/bottomlogo.JPG" alt="PO Footer" style="height:80px; width:97%"/>
            </div>
    ...
    <div id="divToPrint3">
        <div id="divTableDataHolder3" style="width: 880px">
            <div style="width: 85%">
                <img src="../Style/Images/HeaderImg.png" alt="PO Header" style="width: 100%" />
            </div>
            <div style="text-align: right; padding-right: 30px">
                <b>Page No: <asp:Label runat="server" ID="lblPageNo3" ></asp:Label></b>
            </div>
    ...
    <div id="divToPrint4">
        <div id="divTableDataHolder4" style="width: 880px">
            ...
            <div style="text-align: right; padding-right: 30px">
                <b>Page No: <asp:Label runat="server" ID="lblPageNo4" ></asp:Label></b>
            </div>
            <b><u>ANNEXURE-B</u> </b>
            <br />
            ...
            <table border="0" style="width: 830px; text-align: justify;" id="instruct1">
                <tr>
                    <td colspan="2">
                        <b>United Global Corporation Ltd</b> has been entrusted  the  work  “<asp:Label runat="server" ID="lblProjectName"></asp:Label>” by the SPML Infra Limited / BWSSB.
                        <br />
                        <br />
                ...
                <tr>
                    ...
                    <td>
                        <b>DEFINITIONS :</b>&nbsp; In these General Conditions and in any Work  Order   issued  by  Contractor  to  Subcontractor,  the following words and expressions shall have the meanings hereby assigned to them:
                        <br />
                        <b>1.1ACCEPTED SUBCONTRACT AMOUNT :</b>&nbsp; ‘Accepted Subcontract Amount’ means either the Lump Sum Amount or the total sum derived from the multiplication of quantities of such item and its rates accepted by the Contractor and after deduction of all rebates/debits as per the Accepted Priced Bill of Quantities of the Subcontract stated in or enclosed with the Work Order for the execution and completion of Work fit for the purpose including the remedying of defects therein in accordance with Clause 7 -   ‘The Scope of Work’ of these Conditions.
                        <br />
                        <b>APPLICABLE LAWS :</b>&nbsp; ‘Applicable Laws’ mean all laws, brought in to force and effect by Government ofIndiaortheStateGovernmentorthelocalbodies including rules, regulations and notifications made there under and judgments, decrees, injunctions, writs and orders of any court ofrecord, applicable to  the  Work Order Contract  and the exercise, performance and discharge of the respective rights and obligations of the Parties hereunder, as may be in force and effect during the subsistence of to  the  Work Order Contract   and shall include its statutory modifications, amendments, re- enactments, consolidations and substitutions as maybeinforcefromtimetotime
                        <br />
                        <b>CLIENT:</b>&nbsp; ‘Client’ means the Government/ Government Body/ Company/ Association of Persons/ Proprietary Firm/ Partnership Firm/ Individual or any other person, as notified to the Subcontractor from time to time by the Contractor and includes __________  (  Employer/ EPC  Contractor ) and the legal successors in title to, or assignees of such person.
                        <br />
                        <b>ENGINEER/ CONSULTANT:</b>&nbsp; “Engineer” means the Independent Engineer or Consultantor Representatives or project monitoring teamappointed or authorized by the Contractor or Employer.
                        <br />
                        <b>MAIN CONTRACT:</b>&nbsp; Main Contract means the Agreement dated 29/09/2018 entered into between United Global Corporation Ltd and ____________ read together with (i) Agreement dated 24/09/2018 executed by ________ & Employer along with all its recitals, schedules and any amendments thereto made in accordance with the provisions contained in  Concession Agreement.
                        
                        <div class="invoiceSignature" style="width: 95%; font-weight: bold;margin-top:5px;">
                            <div style="height: 80px">
                                <div style="text-align: right">
                                    <img src="../Style/Images/Img_Sign.jpeg" style="Height:70px; Width:180px;"/>
                                </div>
                        ...
                        <div style="width: 85%">
                          ...
                          <div style="text-align: right; padding-right: 30px">
                             <b>Page No: <asp:Label runat="server" ID="lblPageNo5" ></asp:Label></b>
                        </div>

                        <b>CONTRACTOR:</b>&nbsp; ‘Contractor’ means United Global Corporation Ltd, having its Office situated at No.399,1st Floor, 24th Cross, Banashankari 2nd Stage, Bangalore, India – 560070   and shall deem to mean and include its successors and assigns.
                        <br />
                        ...
                        <div class="invoiceSignature" style="width: 95%; font-weight: bold;margin-top:15px;">
                            <div style="height: 80px">
                                <div style="text-align: right">
                                    <img src="../Style/Images/Img_Sign.jpeg" style="Height:70px; Width:180px;"/>
                                </div>
                ...
                <tr>
                    <td class="firsttd"></td>
                       <td> <div style="width: 85%">
                          ...
                          <div style="text-align: right; padding-right: 30px">
               <b>Page No: <asp:Label runat="server" ID="lblPageNo6" ></asp:Label></b>
            </div></td>
                </tr>
                <tr>
                    <td class="firsttd">
                ...
                <tr>
                    ...
                    <td>
                        <b>REPRESENTATIONS AND WARRANTIES :</b>&nbsp; Unless  otherwise  intimated  in  writing  by  the  sub-contractor  to  the  Contractor  during  the  tenure  of  these  General  Terms  and  Condition,  the Subcontractor hereby  , represents, warrants and confirms to the Contractor that :
                        <br />
                ...
                <tr>
                    ...
                    <td>
                       <div style="width: 85%">
                        ...
                        <div style="text-align: right; padding-right: 30px">
                              <b>Page No: <asp:Label runat="server" ID="lblPageNo7" ></asp:Label></b>
                        </div>
                ...
                <tr>
                    ...
                    <td>
                        <b>SUBCONTRACTOR’S GENERAL OBLIGATIONS :</b>&nbsp;The Subcontractor’s general obligations, duties, responsibilities and liabilities shall include, but not limited to, the following:
                        <br />
                        ...
                        <div class="invoiceSignature" style="width: 95%; font-weight: bold;margin-top: 65px;
}">
                            <div style="height: 80px">
                                <div style="text-align: right">
                                    <img src="../Style/Images/Img_Sign.jpeg" style="Height:70px; Width:180px;"/>
                        ...
                        <div style="width: 85%">
                          ...
                          <div style="text-align: right; padding-right: 30px">
                 <b>Page No: <asp:Label runat="server" ID="lblPageNo8" ></asp:Label></b>
            </div> 
                        ...
                        <br />
                        <b>ENVIRONMENTALPROTECTION: </b>In addition to the strict compliance of all the Applicable Laws,Employers Agreement   and the Contractor’s Manual and instructions for ‘Safety, Health and Environment’; the Subcontractor shall ensure and take all required steps to protect the environment (both on and off the Site) and to limit damage and nuisance to people and property resulting from pollution, noise and other results of its operations. The Subcontractor shall ensure that emissions, surface discharges and effluent from the Subcontractor’s activities shall not exceed the values stated in the Specification or prescribed by the Applicable Laws.
                        <br />
                        ...
                        <br />
                        <br />
                        <div class="invoiceSignature" style="width: 95%; font-weight: bold;margin-top:85px;">
                            <div style="height: 80px">
                                <div style="text-align: right">
                                    <img src="../Style/Images/Img_Sign.jpeg" style="Height:70px; Width:180px;"/>
                                </div>
               ...
               <b>Page No: <asp:Label runat="server" ID="lblPageNo9" ></asp:Label></b>
                        ...
                        <div class="invoiceFooter">
                          ...
                          <div style="text-align: right; padding-right: 30px">
                   <b>Page No: <asp:Label runat="server" ID="lblPageNo10" ></asp:Label></b>
            </div>
                        ...
                        <br />
                        The Subcontractor shall not be entitled to assign the Work Order or the rights, benefits and obligations hereunder save and except with prior written consent of the Contractor.
                        <br />
  ...
  <div style="text-align: right; padding-right: 30px">
                <b>Page No: <asp:Label runat="server" ID="lblPageNo11" ></asp:Label></b>
            </div>
                ...
                <tr>
                    <td class="firsttd"></td>
                    <td> If required under the Main Contract, the Subcontractor shall ensure, provide and comply with any and all obligations, and additional warranties, guarantees and all other requirements there under.
                        <br />
                        <b>SUBCONTRACTOR’S SUPERINTENDENCE: </b>Throughout the execution of the Works, and as long thereafter as is necessary to fulfill the Subcontractor’s obligations, the Subcontractor shall provide all necessary Superintendence to plan, arrange, direct, execute, manage, inspect and test the works. Superintendence shall be given by sufficient number of persons having adequate knowledge of the operations to be carried out (including the methods and techniques required, the hazards likely to be encountered and methods of preventing accidents) for the satisfactory and safe execution of the Works
                        <br /></td>
                </tr>
                <tr>
                    <td class="firsttd">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <div style="text-align: right; padding-right: 30px">
                <b>Page No: <asp:Label runat="server" ID="lblPageNo12" ></asp:Label></b>
            </div>
                    </td>
                </tr>
                <tr>
                    <td class="firsttd"></td>
                    <td> The unit rates shall cover all minor and major accessories and work including minor / major change in alignments or any other portion even though not specifically mentioned in the specification and/or drawing but are required for completion of the work, as per Contractor’s requirement. No idling or mobilization & demobilization charges shall be paid to the subcontractor on any account whatsoever. In case ,  any  of  the  above  cost  is  incurred  by  the  Contractor for carrying out the works under sub-contractor’s scope, the same shall be charged and  deducted  from  the invoices or dues  of  sub-contractors.</td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        <b>ESCALATION :</b>&nbsp;Unless otherwise specified in the Work Order, the Accepted Subcontract Amount shall be firm till the completion of the Subcontract Works and shall not be subject to escalation of any kind whatsoever.
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        <b>ESTIMATED QUANTITIES :</b>&nbsp;It shall be clearly understood that Contractor does not accept any responsibility for the correctness or completeness of schedule of items covering the scope of the Work Order and the same is liable to alterations, deductions or additions at the discretion of Contractor / Employer or as set forth elsewhere in the Work Order. The Contractor reserves the right to amend / modify the above scope and delete any item of work from subcontractor’s scope. The quantity mentioned in the bill of quantity is tentative and shall be subjected to variation from time to time. If the quantities vary downward, the rates shall be firm & fixed throughout the execution period for the revised quantity. The quantities shown in the Work Order are estimates only and are not guaranteed and may be increased or decreased by the Contractor and the Subcontractor shall be entitled only to payment for the amount of work actually executed by the Subcontractor / Certified by the Contractor’s Authorized Representative   at the rates accepted in the Work Order and the Subcontractor shall notbe entitled to any compensation or other payments in respect of such variation in quantities.
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <div style="text-align: right; padding-right: 30px">
               <b>Page No: <asp:Label runat="server" ID="lblPageNo13" ></asp:Label></b>
            </div>
                        ...
                        <br />
                        The Subcontractor shall have its books of accounts audited by a qualified, competent and independent Chartered Accountantand submit certificate of audit report / certificate from such independent Chartered Accountant.
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <br />
                        Unless otherwise specified in the  Work Order, eligible payment will be released to the Subcontractor by the Contractor within 30 (Thirty ) days after receiving corresponding payment from the Employer/EPC Contractor subject to any statutory and other deductions and monies owed by the Subcontractor to the Contractor including recoveries against mobilization or plant advance, if any; interest on mobilization or plant advance, if any; cash retention, security deposit, deduction of monies due to the Contractor towards any plant, machinery, materials or services arranged by the Contractor on behalf of the Subcontractor and damages/costs levied by the Contractor / the Client / Government  Authority, if any. Notwithstanding any other provision contained herein to the contrary or otherwise, no payment shall be made to the Subcontractor unless corresponding payment against the WorkOrder has been received by the Contractor from the Client.  Any Payment by the Contractor to the Subcontractor shall be ‘on Account’ payment and no payment made by the Contractor hereunder shall be deemed to constitute acceptance by the Contractor of the Works or any part thereof.  The Contractor reserves its right to withhold payments due to the Subcontractor, if the Subcontractor has failed to perform in accordance with the Work Order Contract and/or has failed to remedy the defects to the satisfaction of the Contractor.  
                        <br />
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <div style="text-align: right; padding-right: 30px">
                 <b>Page No: <asp:Label runat="server" ID="lblPageNo14" ></asp:Label></b>
            </div>
                     </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        <b>CLAIMS :</b>&nbsp;Notice for Claims, if any, shall be served by the Subcontractor to Authorized Signatory of the Contractor at its office situated atBangalore within 14 (Fourteen) days of the occurrence of the event. Claims, if any, shall be substantiated with supporting documents along with the statement which shall state the amount due and payable to the Subcontractor under the Work Order. If the Subcontractor do not submit its claim(s) for whatsoever reason within the stipulated time as above to the Authorized Signatory at its Office, the same shall be deemed to be waived. Notwithstanding any other provision contained herein to the contrary or otherwise, no claims of the Subcontractor shall be admitted (nor deemed to be payable) unless the Employer admits and pays the corresponding claims of the Contractor. Notwithstanding any other provision contained herein to the contrary or otherwise, the Subcontractor shall not be paid any idling charges whatsoever under whatever nomenclature called.
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        <b>TAKING OVER OF THEWORKS :</b>&nbsp;Until the issuance of Taking Over Certificate for the entire Project or in part by the Employer, no sections or part thereof done by the Subcontractor shall be deemed to be completed or deemed to be accepted or deemed to be taken over by the Contractor.
                    </td>
                </tr>
            ...
            <div class="invoiceFooter">
                ...
                <tr>
                    ...
                    <div style="width: 85%">
                        <img src="../Style/Images/HeaderImg.png" alt="PO Header" style="width:100%"/>
                         ...
                         <div style="text-align: right; padding-right: 30px">
                 <b>Page No: <asp:Label runat="server" ID="lblPageNo15" ></asp:Label></b>
            </div>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        <b>NON-PERFORMANCE :</b>&nbsp;In case the Subcontractor does not commence the work within dates stipulated in work Order or does not mobilize adequate resources, or does not progress satisfactorily, or does not make good shortfall in achievement of required progress or does not follow safe practices or does not , to  the  Satisfaction of  Engineer , execute work in accordance with the specification drawings , codes and standards or does not protect the environment or does not maintain quality of work or neglects or does not comply with instructions, or do not make payments to their workmen and other creditors, or do not comply and observe statutory Laws of the place of work or fails to comply with any of the terms and condition of Work Order Contract  or in case of any other form or non-performance by the Subcontractor, then the Contractor reserves its rights to take any or all of the following remedial measures (not necessarily in the same order) by serving 7 (Seven) day Notice; at the risk, cost and consequences of  the Subcontractor (a) Curtail or reduce the Scope Of Work ; or/and (b) Retain the Subcontractor’s Equipment and carry out the balance work in full or in part (including any rectification in work already executed by the Subcontractor) either on its own or through any other party at the risk, cost and consequences of the Subcontractor  as well as recover all costs and losses from the Subcontractor ; or/and (c) Confiscate Cash Retention money/ Security Deposit ; or/and (d) Invoke any or all Bank Guarantee (ies) (i.e. Performance or Advance or Retention or Security Deposit) ; or/and (e)  Terminate the Work Order  in accordance with Clause 30 ; or/and (f)  Any other method as appropriate for due performance.  For this purpose, the Contractor shall also have the right to invoke Cross Fall Breach and Set Off provisions of Clause 23.
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <div style="width: 85%">
                        <img src="../Style/Images/HeaderImg.png" alt="PO Header" style="width:100%"/>
                         ...
                         <div style="text-align: right; padding-right: 30px">
                 <b>Page No: <asp:Label runat="server" ID="lblPageNo16" ></asp:Label></b>
            </div>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        <b>INDEMNITY :</b>&nbsp;The Subcontractor hereby indemnifies and keeps indemnified and hold harmless the Contractor / Employer against and from all claims, actions, suits, demands, liabilities, charges, and any / all proceedings and any/ all losses or damages or cost or expenses (including legal fees and expenses) including third party claims that may be suffered, incurred or expected to be so suffered or incurred by  the  Contractor  / Employer on account of anything done or omitted to be done by the Subcontractor in connection with the Work Order  or any part thereof, the Works and performance of its obligations, duties, responsibilities or liabilities under  the  Work Order Contract  or otherwise.
                ...
                <tr>
                    ...
                    <td>
                        <b>EXCLUSIONS :</b>&nbsp;The Sub Contractor  has clearly understood that the terms and conditions herein contained, has been negotiated by and entered into on behalf of the Contractor / Contractors project team and the Sub Contractor understands and accepts that the other Partner/Director of the Contractor or any of  the Accounts Officer of the Contractor has no part to play in the negotiations and execution of these presents and accordingly is not liable at all in contract, tort or crime in respect of theWork Order Contract or any acts pertaining thereto including prior to its execution. The Sub Contractor accordingly undertakes that under no circumstances shall he/she/it sue and/or prosecute the Partner/Director of the Contractor or any of theAccounts Officer of the Contractor in respect of the breach of any terms and conditions herein or in respect of any acts, deeds or statements that preceded to the Work Order Contract and pertaining to it.
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <div style="text-align: right; padding-right: 30px">
              <b>Page No: <asp:Label runat="server" ID="lblPageNo17" ></asp:Label></b>
            </div>
                     </td>
                </tr>
                 ...
                 <tr>
                    ...
                    <td>
                        ...
                        <div class="invoiceSignature" style="width: 95%; font-weight: bold;margin-top:60px;">
                            <div style="height: 80px">
                                <div style="text-align: right">
                                    <img src="../Style/Images/Img_Sign.jpeg" style="Height:70px; Width:180px;"/>
                                </div>
                ...
                <tr>
                    ...
                    <td>
                        <div style="width: 85%">
                          ...
                          <div style="text-align: right; padding-right: 30px">
                 <b>Page No: <asp:Label runat="server" ID="lblPageNo18" ></asp:Label></b>
            </div>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        <b>APPLICABLE LANGUAGE :</b>&nbsp;The ruling language of the Work Order including all documents thereof and for all further correspondence between the Contractor and the Subcontractor shall be English.
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        <b>GOVERNING LAWS :</b>&nbsp;The Work Order shall be governed by the Laws of India and courts in Bangalore shall have exclusive jurisdiction over all matters arising out of or relating to the Work Order Contract. Notwithstanding the place where the Work Order is signed or the place where the work under the Work Order is to be executed, it is mutually understood and agreed by and between the Parties hereto, that the Work Order Contract shall be deemed to have been entered into by the Parties concerned in the City of Bangalore.
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        <b>PRINCIPAL TO PRINCIPAL :</b>&nbsp;It is agreed and understood that, as between the Contractor / Employer and the Subcontractor, the legal relationship is strictly on a principal-to-principal basis. Nothing is deemed to constitute or imply any other legal relationship such as principal- agent, master-servant or otherwise. It is expressly agreed that there shall be no principal- agent, master-servant or any other relationship between the Contractor and the Subcontractor under these General Terms and Conditions and WorkOrder and no representation to any such effect would be made by the Subcontractor to anyone.  The Subcontractor shall indemnify the Contractor / Employer against any claims, expenses, liabilities and losses and for any third-party claims regarding and/or arising under or in connection with the relationship and/or misrepresentation thereby by the Subcontractor.
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        <div style="width: 85%">
                          ...
                          <div style="text-align: right; padding-right: 30px">
                <b>Page No: <asp:Label runat="server" ID="lblPageNo19" ></asp:Label></b>
            </div>
                    </td>
                </tr>
                  <tr>
             <td class="firsttd">
               ...
               <td>
 <b>PRINCIPAL TO PRINCIPAL :</b>&nbsp;All matters related to the Work Order Contract, the Works and all other documents shall be regarded by the Subcontractor as being highly confidential and shall not be disclosed to any party, person or entity. The Subcontractor shall at no time hereinafter use any technical information or intellectual property, in relation to the Work Order Contract and the Main Contract. The Subcontractor shall not have the right to advertise or otherwise permit the dissemination of publicity concerning the Work Order Contract.This Confidentiality obligation shall survive expiry or termination of the Work Order.
               </td>
         </tr>
                <tr>
                    <td class="firsttd">
                ...
                <tr>
                    ...
                    <td>
                        <b>ACCEPTANCE OF W.O. :</b>&nbsp;The W.O and the terms herein shall be deemed to be accepted by the Sub-Contractor upon the receipt of the W.O. or advance to his account unless expressly rejected by Sub-Contractor in writing or Sub-Contractor has returned the advance.
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        Parties hereto agrees thatunless otherwise specifically mentioned in the Work Order:
                        <br />
                        (i)	These general terms and conditions shall form part of any resulting Work Orderplaced by Contractor on Subcontractor.  
                        <br />
            ...
            <table border="0" style="width: 550px; border:1px solid white">
                ...
                <tr>
                    <td style="width:50%; font-weight:bold; padding-left:30px">For Sub-Contractor</td>
                    <td style="width:50%; font-weight:bold; padding-left:30px">For Contractor</td>
                </tr>
    ...
    <div id="divToPrint5">
        <div id="divTableDataHolder5" style="width: 880px">
            <div style="width: 85%">
             ...
             <div style="text-align: right; padding-right: 30px">
                <b>Page No: <asp:Label runat="server" ID="lblPageNo20" ></asp:Label></b>
            </div>
            <b><u>ANNEXURE-C</u> </b>
            <br />
