<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/SNC.Master" AutoEventWireup="true" CodeBehind="WorkOrderHire.aspx.cs" Inherits="WorkOrderHire" %>
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <asp:TextBox runat="server" ID="txtGstNo" Enabled="false" CssClass="form-control" MaxLength="15"></asp:TextBox>
                </div>
            ...
            <div class="row">
                <div class="col-md-2">Scope Of Work</div>
                <div class="col-md-10">
                    <asp:TextBox runat="server" ID="txtScopeOfWork" CssClass="form-control" Style="resize: none" TextMode="MultiLine" Rows="3" TabIndex="15"></asp:TextBox>
                </div>
            </div>
            ...
            <div class="row" runat="server" id="div_Draft" visible="false">
                ...
                <div class="col-md-4">
                    <asp:CheckBox runat="server" ID="chkDraft" Text="Draft Confidential" AutoPostBack="true" OnCheckedChanged="chkDraft_ChckedChanged" TabIndex="15"></asp:CheckBox>
                </div>
            ...
            <div class="row">
                <div class="col-md-12 text-center">
                    <asp:Button ID="btnAddItem" runat="server" Visible="false" Text="Add Item" CssClass="btn btn-default" CausesValidation="false" OnClick="btnAddItem_Click" TabIndex="16"></asp:Button>
                    <asp:Button ID="btnSubmit" runat="server" Text="Submit" ValidationGroup="ValWO" OnClick="btnSubmit_Click" CssClass="btn btn-default" TabIndex="17"></asp:Button>
                    <asp:Button ID="btnCancel" runat="server" Text="Cancel" OnClick="btnCancel_Click" CssClass="btn btn-default" TabIndex="18"></asp:Button>
                    ...
                    <asp:Button ID="btnPrintPDF" runat="server" Text="PDF Print" OnClick="btnPrintPDF_Click" CssClass="btn btn-default" tabindex="19" Visible="false"></asp:Button>
                      <asp:Button ID="btnApproveWHO" Text="Approve" CssClass="btn btn-default" runat="server" OnClick="btnApproveWHO_Click" CausesValidation="false" Visible="false" TabIndex="22" />
                </div>
            </div>
            <br />
            ...
            <center>
                ...
                <ogrid:Grid runat="server" ID="Grid_WOItem" ShowColumnsFooter="true"  
                    ...
                    <Columns>
                        ...
                        <ogrid:Column DataField="Item_Type" HeaderText="Work Order Type" Width="150px" Wrap="true" >
                            <TemplateSettings TemplateId="ItemTemplate" />
                        </ogrid:Column>
                        <ogrid:Column DataField="Item_Desc" HeaderText="WO Description" Width="300px" Wrap="true" ></ogrid:Column>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <asp:TextBox ID="txtWOPerc" runat="server" autocomplete="off" Text="0.00" onPaste="javascript:return false" CssClass="form-control input-pos-float"></asp:TextBox>
                        </div>
                        <div class="col-md-2">
                            Rate&nbsp;
                        ...
                        <div class="col-md-4">
                            <asp:TextBox ID="txtRate" runat="server" autocomplete="off" Text="0.00" onPaste="javascript:return false" CssClass="form-control input-pos-float"></asp:TextBox>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <asp:TextBox ID="txtAmount" runat="server" onkeyup="CalculateItemTaxAmt()" autocomplete="off" Text="0.00" onPaste="javascript:return false" CssClass="form-control input-pos-float"></asp:TextBox>
                        </div>
