<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/SNC.Master" AutoEventWireup="true" CodeBehind="~/Procurement/WorkOrderList.aspx.cs" Inherits="WorkOrderList" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
                <h4 style="text-align:center"> Pending Work Orders </h4>
             <center>
                <ogrid:Grid runat="server" ID="GridWO_Pending" CallbackMode="false" AutoGenerateColumns="false" 
                ...
                <br />
                 <h4 style="text-align:center"> Approved Work Orders </h4>
                <center>
                   <%-- <a href="WorkOrder.aspx" runat="server" id="A1" class="btn btn-default">Add New WO</a>               
            ...
            <center>
                ...
                <br />
                <center>
                    <a href="WorkOrder.aspx" runat="server" id="lnkbtnAdd" class="btn btn-default">Add New WO</a>               
                    <%--<asp:Button ID="btnExportToPDF" runat="server" Text="Export To PDF" OnClick="btnExportToPDF_Click" CssClass="btn btn-default"></asp:Button>--%>
                    <input onclick="exportgrid()" type="button" class="btn btn-default" name="Export To Excel" value=" Export To Excel" />  
                    <%--<asp:Button ID="btn_GenWOItemsList"  runat="server" Text="Generate WO Items List"  OnClick="btn_GenWOItemsList_Click" CssClass="btn btn-default"/>--%>   
                </center>
